...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/zuozizuozi/p-zaovra/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for zuozizuozi/p-zaovra...\n")
...
console.log("Fetching npm all-time downloads for zaovra-ai...\n")
const npmDownloads = await fetchNpmDownloads("zaovra-ai")
