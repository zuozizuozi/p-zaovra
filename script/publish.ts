...
console.log("\n=== cli ===\n")
await $`bun ./packages/zaovra/script/publish.ts`
...
if (Script.release) {
  await $`bun ./packages/desktop-app/scripts/finalize-latest-json.ts`
  await $`bun ./packages/desktop-app/scripts/finalize-latest-yml.ts`
}
