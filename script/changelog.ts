...
Generates UPCOMING_CHANGELOG.md by running the zaovra changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for zaovra run (default: low)
      --quiet            Suppress zaovra command output unless it fails
