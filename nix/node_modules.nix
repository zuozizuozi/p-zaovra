...
let
  packageJson = lib.pipe ../packages/zaovra/package.json [
    builtins.readFile
    builtins.fromJSON
  ];
...
stdenvNoCC.mkDerivation {
  ...
  src = lib.fileset.toSource {
    ...
    fileset = lib.fileset.intersection (lib.fileset.fromSource (lib.sources.cleanSource ../.)) (
      lib.fileset.unions [
        ...
        ../.github/TEAM_MEMBERS # required by @zaovra-ai/script
      ]
    );
  };
  ...
  buildPhase = ''
    ...
    bun install \
      ...
      --os="${bunOs}" \
      --filter '!./' \
      --filter './packages/zaovra' \
      --filter './packages/desktop-app' \
      --filter './packages/app-ui' \
      --frozen-lockfile \
      --ignore-scripts \
      --no-progress
