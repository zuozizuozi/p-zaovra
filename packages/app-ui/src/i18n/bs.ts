export const dict = {
  ...
  "desktop.menu.maximize": "Maksimiziraj / Vrati",
  "desktop.menu.reload": "Ponovo učitaj",
  "desktop.menu.devTools": "Razvojni alati",
  "desktop.menu.actualSize": "Stvarna veličina",
  "desktop.menu.zoomIn": "Povećaj",
  "desktop.menu.zoomOut": "Smanji",
  "desktop.menu.fullScreen": "Prebaci puni ekran",
  "desktop.menu.documentation": "Zaovra dokumentacija",
  "desktop.menu.support": "Zajednica podrške",
  "provider.custom.discovery.restart":
    "Komponenta za povezivanje desktop aplikacije je ažurirana. Zatvorite i ponovo otvorite Zaovra da preuzmete modele. Trenutni unos je sačuvan.",
  "provider.custom.discovery.environment":
    "Ovdje nije moguće pročitati ključeve iz varijabli okruženja. Ručno unesite ID-ove modela ili zalijepite ključ za preuzimanje liste.",
  "provider.custom.discovery.timeout":
    "Usluga nije odgovorila u roku od 15 sekundi. Pokušajte ponovo ili ručno unesite modele.",
  "provider.custom.discovery.unsupported":
    "Ova usluga ne podržava listanje modela na ovoj adresi. Provjerite URL ili ručno unesite ID modela.",
  "provider.custom.discovery.saved": "Konfiguracija za {provider} je sačuvana",
  "provider.custom.discovery.savedDescription":
    "Odaberite model da započnete zadatak. Generisanje i pozivanje alata nisu provjereni.",
  "provider.custom.discovery.intro": "Unesite URL usluge i API ključ, zatim preuzmite listu modela.",
  "provider.custom.discovery.fetch": "Preuzmi modele",
  "provider.custom.discovery.loading": "Preuzimanje modela…",
  "provider.custom.discovery.manual": "Ručno unesi modele",
  "provider.custom.discovery.advanced": "Napredne postavke",
  "provider.custom.discovery.auto": "Automatski",
  "provider.custom.discovery.save": "Sačuvaj konfiguraciju",
  "provider.custom.discovery.search": "Pretraži modele",
  "provider.custom.discovery.success":
    "Lista modela je primljena. Prvi model je odabran; promijenite odabir po potrebi. Ovo ne provjerava podršku za generisanje ili alate.",
  "provider.custom.discovery.auth": "Autentifikacija nije uspjela. Provjerite API ključ i adresu usluge.",
  "provider.custom.discovery.rate":
    "Dostignuto je ograničenje zahtjeva. Pokušajte kasnije ili ručno unesite ID modela.",
  "provider.custom.discovery.url":
    "Unesite važeći HTTP(S) URL usluge bez pristupnih podataka, parametara upita ili fragmenata.",
  "provider.custom.discovery.empty": "Usluga nije vratila modele. Možete ručno unijeti ID modela.",
  "provider.custom.discovery.failed":
    "Nije moguće preuzeti modele. Provjerite adresu i mrežu, pokušajte ponovo ili ručno unesite modele. Konfiguracija nije sačuvana.",
  "provider.custom.discovery.choose": "Odaberite barem jedan model ili ručno unesite ID modela.",
  ...
  "dialog.provider.zaovra.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.zaovra.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.zaovraGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Zaovra",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Zaovra-u.",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.zaovraZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.zaovraZen.visit.prefix": "Posjeti ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Zaovra-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Zaovra-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u zaovra.json",
  ...
  "dialog.server.description": "Promijeni na koji se Zaovra server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingZaovra": "Provjera Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "Provjera Zaovra u distribuciji {{distro}}...",
  "wsl.onboarding.updatingZaovra": "Ažuriranje Zaovra...",
  "wsl.onboarding.updatingZaovraIn": "Ažuriranje Zaovra u distribuciji {{distro}}...",
  "wsl.onboarding.updateZaovraIn": "Ažuriraj Zaovra u distribuciji {{distro}}.",
  "wsl.onboarding.updateZaovra": "Ažuriraj Zaovra",
  "wsl.onboarding.zaovraReadyIn": "Zaovra je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.zaovraReady": "Zaovra je spreman.",
  "wsl.onboarding.installZaovraIn": "Instaliraj Zaovra u distribuciji {{distro}}.",
  "wsl.onboarding.installZaovra": "Instaliraj Zaovra",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Zaovra mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Zaovra nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Zaovra.",
  ...
  "toast.update.description": "Nova verzija Zaovra-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Zaovra timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (zaovra.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Zaovra još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Zaovra uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Zaovra server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Zaovra-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Zaovra izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Zaovra prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Zaovra-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Zaovra pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Zaovra-a.",
