...
export const dict = {
  ...
  "desktop.menu.maximize": "Ekranı kapla / Geri yükle",
  "desktop.menu.reload": "Yeniden yükle",
  "desktop.menu.devTools": "Geliştirici araçları",
  "desktop.menu.actualSize": "Gerçek boyut",
  "desktop.menu.zoomIn": "Yakınlaştır",
  "desktop.menu.zoomOut": "Uzaklaştır",
  "desktop.menu.fullScreen": "Tam ekranı değiştir",
  "desktop.menu.documentation": "Zaovra belgeleri",
  "desktop.menu.support": "Destek topluluğu",
  "provider.custom.discovery.restart":
    "Masaüstü uygulamasının bağlantı bileşeni güncellendi. Modelleri getirmek için Zaovra'yı kapatıp yeniden açın. Girdiğiniz bilgiler korunur.",
  "provider.custom.discovery.environment":
    "Ortam değişkenlerindeki anahtarlar burada okunamaz. Model kimliklerini elle girin veya listeyi getirmek için bir anahtar yapıştırın.",
  "provider.custom.discovery.timeout":
    "Hizmet 15 saniye içinde yanıt vermedi. Yeniden deneyin veya modelleri elle girin.",
  "provider.custom.discovery.unsupported":
    "Bu hizmet, bu adreste model listelemeyi desteklemiyor. URL'yi kontrol edin veya bir model kimliğini elle girin.",
  "provider.custom.discovery.saved": "{provider} yapılandırması kaydedildi",
  "provider.custom.discovery.savedDescription":
    "Bir görev başlatmak için model seçin. Üretim ve araç çağrıları henüz doğrulanmadı.",
  "provider.custom.discovery.intro": "Hizmet URL'sini ve API anahtarını girip model listesini getirin.",
  "provider.custom.discovery.fetch": "Modelleri getir",
  "provider.custom.discovery.loading": "Modeller getiriliyor…",
  "provider.custom.discovery.manual": "Modelleri elle gir",
  "provider.custom.discovery.advanced": "Gelişmiş ayarlar",
  "provider.custom.discovery.auto": "Otomatik",
  "provider.custom.discovery.save": "Yapılandırmayı kaydet",
  "provider.custom.discovery.search": "Model ara",
  "provider.custom.discovery.success":
    "Model listesi alındı. İlk model seçildi; gerekirse seçimi değiştirin. Bu işlem üretim veya araç desteğini doğrulamaz.",
  "provider.custom.discovery.auth": "Kimlik doğrulama başarısız. API anahtarını ve hizmet adresini kontrol edin.",
  "provider.custom.discovery.rate": "İstek sınırına ulaşıldı. Daha sonra deneyin veya bir model kimliğini elle girin.",
  "provider.custom.discovery.url":
    "Kimlik bilgileri, sorgu parametreleri veya parçalar içermeyen geçerli bir HTTP(S) hizmet URL'si girin.",
  "provider.custom.discovery.empty": "Hizmet hiçbir model döndürmedi. Bir model kimliğini elle girebilirsiniz.",
  "provider.custom.discovery.failed":
    "Modeller getirilemedi. Adresi ve ağı kontrol edip yeniden deneyin veya modelleri elle girin. Yapılandırma kaydedilmedi.",
  "provider.custom.discovery.choose": "En az bir model seçin veya bir model kimliğini elle girin.",
  ...
  "dialog.provider.zaovra.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.zaovra.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.zaovraGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Zaovra tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Zaovra'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.zaovraZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Zaovra'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Zaovra'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler zaovra.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Zaovra sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingZaovra": "Zaovra kontrol ediliyor...",
  "wsl.onboarding.checkingZaovraIn": "{{distro}} içinde Zaovra kontrol ediliyor...",
  "wsl.onboarding.updatingZaovra": "Zaovra güncelleniyor...",
  "wsl.onboarding.updatingZaovraIn": "{{distro}} içinde Zaovra güncelleniyor...",
  "wsl.onboarding.updateZaovraIn": "{{distro}} içindeki Zaovra'u güncelleyin.",
  "wsl.onboarding.updateZaovra": "Zaovra'u güncelle",
  "wsl.onboarding.zaovraReadyIn": "{{distro}} içinde Zaovra hazır.",
  "wsl.onboarding.zaovraReady": "Zaovra hazır.",
  "wsl.onboarding.installZaovraIn": "Zaovra'u {{distro}} içine kurun.",
  "wsl.onboarding.installZaovra": "Zaovra'u kur",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Zaovra'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Zaovra bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Zaovra'u tekrar açın.",
  ...
  "toast.update.description": "Zaovra'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Zaovra ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (zaovra.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Zaovra henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Zaovra ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Zaovra Masaüstü",
  ...
  "settings.desktop.wsl.description": "Zaovra sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Zaovra'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Zaovra'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Zaovra'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Zaovra'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Zaovra başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Zaovra'un en son sürümünü kullanıyorsunuz.",
