export const dict = {
  ...
  "desktop.menu.maximize": "Maksymalizuj / Przywróć",
  "desktop.menu.reload": "Odśwież",
  "desktop.menu.devTools": "Narzędzia deweloperskie",
  "desktop.menu.actualSize": "Rzeczywisty rozmiar",
  "desktop.menu.zoomIn": "Powiększ",
  "desktop.menu.zoomOut": "Pomniejsz",
  "desktop.menu.fullScreen": "Przełącz pełny ekran",
  "desktop.menu.documentation": "Dokumentacja Zaovra",
  "desktop.menu.support": "Społeczność wsparcia",
  "provider.custom.discovery.restart":
    "Zaktualizowano komponent połączenia aplikacji komputerowej. Zamknij i ponownie otwórz Zaovra, aby pobrać modele. Wprowadzone dane zostaną zachowane.",
  "provider.custom.discovery.environment":
    "Nie można tu odczytać kluczy ze zmiennych środowiskowych. Wpisz identyfikatory modeli ręcznie lub wklej klucz, aby pobrać listę.",
  "provider.custom.discovery.timeout":
    "Usługa nie odpowiedziała w ciągu 15 sekund. Spróbuj ponownie lub wpisz modele ręcznie.",
  "provider.custom.discovery.unsupported":
    "Ta usługa nie obsługuje listowania modeli pod tym adresem. Sprawdź URL lub wpisz identyfikator modelu ręcznie.",
  "provider.custom.discovery.saved": "Zapisano konfigurację {provider}",
  "provider.custom.discovery.savedDescription":
    "Wybierz model, aby rozpocząć zadanie. Generowanie i wywoływanie narzędzi nie zostały zweryfikowane.",
  "provider.custom.discovery.intro": "Wpisz URL usługi i klucz API, a następnie pobierz listę modeli.",
  "provider.custom.discovery.fetch": "Pobierz modele",
  "provider.custom.discovery.loading": "Pobieranie modeli…",
  "provider.custom.discovery.manual": "Wpisz modele ręcznie",
  "provider.custom.discovery.advanced": "Ustawienia zaawansowane",
  "provider.custom.discovery.auto": "Automatycznie",
  "provider.custom.discovery.save": "Zapisz konfigurację",
  "provider.custom.discovery.search": "Szukaj modeli",
  "provider.custom.discovery.success":
    "Otrzymano listę modeli. Wybrano pierwszy model; w razie potrzeby zmień wybór. Nie potwierdza to obsługi generowania ani narzędzi.",
  "provider.custom.discovery.auth": "Uwierzytelnianie nie powiodło się. Sprawdź klucz API i adres usługi.",
  "provider.custom.discovery.rate": "Osiągnięto limit żądań. Spróbuj później lub wpisz identyfikator modelu ręcznie.",
  "provider.custom.discovery.url":
    "Wpisz prawidłowy URL usługi HTTP(S) bez danych logowania, parametrów zapytania ani fragmentów.",
  "provider.custom.discovery.empty": "Usługa nie zwróciła żadnych modeli. Możesz wpisać identyfikator modelu ręcznie.",
  "provider.custom.discovery.failed":
    "Nie udało się pobrać modeli. Sprawdź adres i sieć, spróbuj ponownie lub wpisz modele ręcznie. Nie zapisano konfiguracji.",
  "provider.custom.discovery.choose": "Wybierz co najmniej jeden model lub wpisz identyfikator modelu ręcznie.",
  ...
  "dialog.provider.zaovra.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.zaovra.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.zaovraGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Zaovra",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Zaovra.",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.zaovraZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.zaovraZen.visit.prefix": "Odwiedź ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Zaovra.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Zaovra.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w zaovra.json",
  ...
  "dialog.server.description": "Przełącz serwer Zaovra, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingZaovra": "Sprawdzanie Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "Sprawdzanie Zaovra w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingZaovra": "Aktualizowanie Zaovra...",
  "wsl.onboarding.updatingZaovraIn": "Aktualizowanie Zaovra w dystrybucji {{distro}}...",
  "wsl.onboarding.updateZaovraIn": "Zaktualizuj Zaovra w dystrybucji {{distro}}.",
  "wsl.onboarding.updateZaovra": "Zaktualizuj Zaovra",
  "wsl.onboarding.zaovraReadyIn": "Zaovra jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.zaovraReady": "Zaovra jest gotowy.",
  "wsl.onboarding.installZaovraIn": "Zainstaluj Zaovra w dystrybucji {{distro}}.",
  "wsl.onboarding.installZaovra": "Zainstaluj Zaovra",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Zaovra będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Zaovra nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Zaovra.",
  ...
  "toast.update.description": "Nowa wersja Zaovra ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Zaovra",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (zaovra.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Zaovra nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Zaovra zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Zaovra wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Zaovra",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Zaovra na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Zaovra ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Zaovra.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Zaovra",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Zaovra.",
