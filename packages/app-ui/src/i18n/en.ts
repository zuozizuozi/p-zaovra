export const dict = {
  ...
  "session.outcome.abandon": "Abandon and archive",
  "session.outcome.abandoned": "Abandoned — previous changes were not rolled back",
  "session.outcome.refresh": "Refresh verification state",
  ...
  "usage.incomplete": "Partial statistics",
  "usage.unreported": "calls without complete usage",
  "usage.unknownSource": "Unidentified source",
  ...
  "usage.ownBalance": "Own Key balance / spending",
  "usage.providerManaged": "Check your provider account",
  ...
  "home.welcome.description": "Describe your idea, choose a project, and start with Zaovra.",
  "home.welcome.continue": "Continue to session",
  ...
  "desktop.menu.maximize": "Maximize / Restore",
  "desktop.menu.reload": "Reload",
  "desktop.menu.devTools": "Toggle Developer Tools",
  ...
  "desktop.menu.documentation": "Zaovra Documentation",
  "desktop.menu.support": "Support Forum",
  ...
  "dialog.provider.custom.label": "Custom model service",
  "dialog.provider.tag.recommended": "Recommended",
  "dialog.provider.zaovra.note": "Managed model access included with a Zaovra membership",
  "dialog.provider.zaovra.tagline": "Managed access through your Zaovra account",
  "dialog.provider.zaovraGo.tagline": "Legacy managed access",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Zaovra",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Zaovra.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.zaovraZen.line1":
    "Zaovra managed models are connected through the Zaovra account used to sign in to the desktop app.",
  "provider.connect.zaovraZen.line2":
    "A paid membership is required for managed model usage. BYOK remains available without a membership.",
  "provider.connect.zaovraZen.visit.prefix": "Visit ",
  "provider.connect.zaovraZen.visit.link": "Zaovra pricing",
  "provider.connect.zaovraZen.visit.suffix": " to choose or manage a membership.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Zaovra.",
  ...
  "provider.custom.discovery.environment":
    "Environment-variable keys cannot be resolved here. Enter model IDs manually or paste a key for discovery.",
  "provider.custom.discovery.timeout": "The service did not respond within 15 seconds. Retry or enter models manually.",
  "provider.custom.discovery.unsupported":
    "This service does not support listing models at this address. Check the URL or enter a model ID manually.",
  ...
  "provider.custom.discovery.advanced": "Advanced settings",
  "provider.custom.discovery.auto": "Automatic",
  "provider.custom.discovery.save": "Save configuration",
  "provider.custom.discovery.search": "Search models",
  "provider.custom.discovery.success":
    "Model list received. The first model is selected; change the selection as needed. This does not verify generation or tool support.",
  "provider.custom.discovery.auth": "Authentication failed. Check the API key and service address.",
  "provider.custom.discovery.rate": "Rate limited. Try again later or enter a model ID manually.",
  "provider.custom.discovery.url":
    "Enter a valid HTTP(S) service URL without credentials, query parameters or fragments.",
  "provider.custom.discovery.empty": "The service returned no models. You can enter a model ID manually.",
  "provider.custom.discovery.failed":
    "Could not fetch models. Check the address and network, retry, or enter models manually. No configuration has been saved.",
  "provider.custom.discovery.choose": "Select at least one model or enter a model ID manually.",
  "provider.custom.title": "Custom provider",
  "provider.custom.description.prefix": "Configure your model service. See the ",
  ...
  "provider.custom.models.name.placeholder": "Optional, defaults to model ID",
  ...
  "dialog.plugins.empty": "Plugins configured in zaovra.json",
  ...
  "dialog.server.description": "Switch which Zaovra server this app connects to.",
  ...
  "wsl.onboarding.checkingZaovra": "Checking Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "Checking Zaovra in {{distro}}...",
  "wsl.onboarding.updatingZaovra": "Updating Zaovra...",
  "wsl.onboarding.updatingZaovraIn": "Updating Zaovra in {{distro}}...",
  "wsl.onboarding.updateZaovraIn": "Update Zaovra in {{distro}}.",
  "wsl.onboarding.updateZaovra": "Update Zaovra",
  "wsl.onboarding.zaovraReadyIn": "Zaovra is ready in {{distro}}.",
  "wsl.onboarding.zaovraReady": "Zaovra is ready.",
  "wsl.onboarding.installZaovraIn": "Install Zaovra in {{distro}}.",
  "wsl.onboarding.installZaovra": "Install Zaovra",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Zaovra can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Zaovra could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Zaovra.",
  ...
  "toast.update.description": "A new version of Zaovra ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Zaovra team",
  ...
  "error.chain.checkConfig": "Check your config (zaovra.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Zaovra does not support MCP authentication yet.',
  ...
  "session.new.title": "Start a new task",
  ...
  "sidebar.gettingStarted.line1": "Zaovra includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Zaovra server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Zaovra",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Zaovra looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Zaovra follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Zaovra is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Zaovra launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Zaovra.",
  ...
  "settings.providers.custom.description": "Connect an OpenAI-compatible, Anthropic, or Gemini service.",
