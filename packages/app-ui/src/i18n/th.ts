export const dict = {
  ...
  "desktop.menu.maximize": "ขยาย / คืนค่าหน้าต่าง",
  "desktop.menu.reload": "โหลดใหม่",
  "desktop.menu.devTools": "เครื่องมือสำหรับนักพัฒนา",
  "desktop.menu.actualSize": "ขนาดจริง",
  "desktop.menu.zoomIn": "ขยาย",
  "desktop.menu.zoomOut": "ย่อ",
  "desktop.menu.fullScreen": "สลับเต็มหน้าจอ",
  "desktop.menu.documentation": "เอกสาร Zaovra",
  "desktop.menu.support": "ชุมชนช่วยเหลือ",
  "provider.custom.discovery.restart":
    "อัปเดตส่วนเชื่อมต่อของแอปเดสก์ท็อปแล้ว ปิดแล้วเปิด Zaovra อีกครั้งเพื่อดึงโมเดล ข้อมูลที่กรอกไว้จะยังคงอยู่",
  "provider.custom.discovery.environment":
    "ไม่สามารถอ่านคีย์จากตัวแปรสภาพแวดล้อมที่นี่ได้ กรอก ID โมเดลเองหรือวางคีย์เพื่อดึงรายการ",
  "provider.custom.discovery.timeout": "บริการไม่ตอบกลับภายใน 15 วินาที ลองอีกครั้งหรือกรอกโมเดลเอง",
  "provider.custom.discovery.unsupported":
    "บริการนี้ไม่รองรับการแสดงรายการโมเดลที่ที่อยู่นี้ ตรวจสอบ URL หรือกรอก ID โมเดลเอง",
  "provider.custom.discovery.saved": "บันทึกการตั้งค่า {provider} แล้ว",
  "provider.custom.discovery.savedDescription":
    "เลือกโมเดลเพื่อเริ่มงาน ยังไม่ได้ตรวจสอบการสร้างเนื้อหาและการเรียกใช้เครื่องมือ",
  "provider.custom.discovery.intro": "กรอก URL ของบริการและคีย์ API แล้วดึงรายการโมเดล",
  "provider.custom.discovery.fetch": "ดึงโมเดล",
  "provider.custom.discovery.loading": "กำลังดึงโมเดล…",
  "provider.custom.discovery.manual": "กรอกโมเดลเอง",
  "provider.custom.discovery.advanced": "การตั้งค่าขั้นสูง",
  "provider.custom.discovery.auto": "อัตโนมัติ",
  "provider.custom.discovery.save": "บันทึกการตั้งค่า",
  "provider.custom.discovery.search": "ค้นหาโมเดล",
  "provider.custom.discovery.success":
    "ได้รับรายการโมเดลแล้ว ระบบเลือกโมเดลแรกไว้ให้ เปลี่ยนได้ตามต้องการ ขั้นตอนนี้ไม่ได้ยืนยันการรองรับการสร้างเนื้อหาหรือเครื่องมือ",
  "provider.custom.discovery.auth": "การยืนยันตัวตนล้มเหลว ตรวจสอบคีย์ API และที่อยู่บริการ",
  "provider.custom.discovery.rate": "ถึงขีดจำกัดคำขอแล้ว ลองอีกครั้งภายหลังหรือกรอก ID โมเดลเอง",
  "provider.custom.discovery.url":
    "กรอก URL บริการ HTTP(S) ที่ถูกต้อง โดยไม่มีข้อมูลเข้าสู่ระบบ พารามิเตอร์การค้นหา หรือส่วนแฟรกเมนต์",
  "provider.custom.discovery.empty": "บริการไม่ได้ส่งคืนโมเดลใด คุณสามารถกรอก ID โมเดลเองได้",
  "provider.custom.discovery.failed":
    "ไม่สามารถดึงโมเดลได้ ตรวจสอบที่อยู่และเครือข่าย ลองอีกครั้งหรือกรอกโมเดลเอง ยังไม่ได้บันทึกการตั้งค่า",
  "provider.custom.discovery.choose": "เลือกอย่างน้อยหนึ่งโมเดลหรือกรอก ID โมเดลเอง",
  ...
  "dialog.provider.zaovra.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.zaovra.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.zaovraGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Zaovra",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Zaovra",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  "provider.connect.zaovraZen.line2":
    "ด้วยคีย์ API เดียวคุณจะได้รับการเข้าถึงโมเดล เช่น Claude, GPT, Gemini, GLM และอื่น ๆ",
  "provider.connect.zaovraZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": " เพื่อรวบรวมคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Zaovra",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Zaovra",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน zaovra.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Zaovra ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingZaovra": "กำลังตรวจสอบ Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "กำลังตรวจสอบ Zaovra ใน {{distro}}...",
  "wsl.onboarding.updatingZaovra": "กำลังอัปเดต Zaovra...",
  "wsl.onboarding.updatingZaovraIn": "กำลังอัปเดต Zaovra ใน {{distro}}...",
  "wsl.onboarding.updateZaovraIn": "อัปเดต Zaovra ใน {{distro}}.",
  "wsl.onboarding.updateZaovra": "อัปเดต Zaovra",
  "wsl.onboarding.zaovraReadyIn": "Zaovra พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.zaovraReady": "Zaovra พร้อมใช้งานแล้ว.",
  "wsl.onboarding.installZaovraIn": "ติดตั้ง Zaovra ใน {{distro}}.",
  "wsl.onboarding.installZaovra": "ติดตั้ง Zaovra",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "ยังไม่ได้ติดตั้ง Zaovra",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Zaovra จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Zaovra ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้.",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Zaovra อีกครั้ง.",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Zaovra ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Zaovra",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (zaovra.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Zaovra ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Zaovra รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Zaovra ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Zaovra",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Zaovra มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Zaovra ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Zaovra มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Zaovra เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Zaovra เวอร์ชันล่าสุด",
