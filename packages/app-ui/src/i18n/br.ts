export const dict = {
  ...
  "desktop.menu.devTools": "Ferramentas do desenvolvedor",
  "desktop.menu.actualSize": "Tamanho real",
  "desktop.menu.zoomIn": "Ampliar",
  "desktop.menu.zoomOut": "Reduzir",
  "desktop.menu.fullScreen": "Alternar tela cheia",
  "desktop.menu.documentation": "Documentação do Zaovra",
  "desktop.menu.support": "Comunidade de suporte",
  "provider.custom.discovery.restart":
    "O componente de conexão do aplicativo foi atualizado. Feche e reabra o Zaovra para buscar modelos. Seus dados serão mantidos.",
  "provider.custom.discovery.environment":
    "Não é possível resolver chaves de variáveis de ambiente aqui. Insira os IDs dos modelos manualmente ou cole uma chave para buscar a lista.",
  "provider.custom.discovery.timeout":
    "O serviço não respondeu em 15 segundos. Tente novamente ou insira os modelos manualmente.",
  "provider.custom.discovery.unsupported":
    "Este serviço não permite listar modelos neste endereço. Verifique a URL ou insira um ID de modelo manualmente.",
  "provider.custom.discovery.saved": "Configuração de {provider} salva",
  "provider.custom.discovery.savedDescription":
    "Selecione um modelo para iniciar uma tarefa. A geração e as chamadas de ferramentas não foram verificadas.",
  "provider.custom.discovery.intro": "Insira a URL do serviço e a chave de API e busque a lista de modelos.",
  "provider.custom.discovery.fetch": "Buscar modelos",
  "provider.custom.discovery.loading": "Buscando modelos…",
  "provider.custom.discovery.manual": "Inserir modelos manualmente",
  "provider.custom.discovery.advanced": "Configurações avançadas",
  "provider.custom.discovery.auto": "Automático",
  "provider.custom.discovery.save": "Salvar configuração",
  "provider.custom.discovery.search": "Buscar modelos",
  "provider.custom.discovery.success":
    "Lista de modelos recebida. O primeiro modelo está selecionado; altere a seleção conforme necessário. Isso não verifica o suporte à geração ou a ferramentas.",
  "provider.custom.discovery.auth": "Falha na autenticação. Verifique a chave de API e o endereço do serviço.",
  "provider.custom.discovery.rate":
    "Limite de solicitações atingido. Tente mais tarde ou insira um ID de modelo manualmente.",
  "provider.custom.discovery.url":
    "Insira uma URL de serviço HTTP(S) válida, sem credenciais, parâmetros de consulta ou fragmentos.",
  "provider.custom.discovery.empty": "O serviço não retornou modelos. Você pode inserir um ID de modelo manualmente.",
  "provider.custom.discovery.failed":
    "Não foi possível buscar os modelos. Verifique o endereço e a rede, tente novamente ou insira os modelos manualmente. Nenhuma configuração foi salva.",
  "provider.custom.discovery.choose": "Selecione pelo menos um modelo ou insira um ID de modelo manualmente.",
  ...
  "dialog.provider.zaovra.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.zaovra.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.zaovraGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Zaovra",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Zaovra.",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.zaovraZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.zaovraZen.visit.prefix": "Visite ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Zaovra.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Zaovra.",
  ...
  "dialog.plugins.empty": "Plugins configurados em zaovra.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Zaovra este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingZaovra": "Verificando o Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "Verificando o Zaovra em {{distro}}...",
  "wsl.onboarding.updatingZaovra": "Atualizando o Zaovra...",
  "wsl.onboarding.updatingZaovraIn": "Atualizando o Zaovra em {{distro}}...",
  "wsl.onboarding.updateZaovraIn": "Atualize o Zaovra em {{distro}}.",
  "wsl.onboarding.updateZaovra": "Atualizar o Zaovra",
  "wsl.onboarding.zaovraReadyIn": "O Zaovra está pronto em {{distro}}.",
  "wsl.onboarding.zaovraReady": "O Zaovra está pronto.",
  "wsl.onboarding.installZaovraIn": "Instale o Zaovra em {{distro}}.",
  "wsl.onboarding.installZaovra": "Instalar o Zaovra",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Zaovra possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Zaovra não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Zaovra novamente.",
  ...
  "toast.update.description": "Uma nova versão do Zaovra ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Zaovra",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (zaovra.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Zaovra ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Zaovra inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Zaovra dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Zaovra",
  ...
  "settings.general.row.appearance.description": "Personalize como o Zaovra aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Zaovra segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Zaovra é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Zaovra iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Zaovra.",
