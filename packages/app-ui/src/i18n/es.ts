export const dict = {
  ...
  "desktop.menu.maximize": "Maximizar / Restaurar",
  ...
  "desktop.menu.fullScreen": "Alternar pantalla completa",
  "desktop.menu.documentation": "Documentación de Zaovra",
  "desktop.menu.support": "Comunidad de soporte",
  "provider.custom.discovery.restart":
    "Se actualizó el componente de conexión de la aplicación de escritorio. Cierra y vuelve a abrir Zaovra para obtener los modelos. Se conservarán tus datos.",
  "provider.custom.discovery.environment":
    "Aquí no se pueden leer las claves de variables de entorno. Introduce los ID de modelo manualmente o pega una clave para obtener la lista.",
  "provider.custom.discovery.timeout":
    "El servicio no respondió en 15 segundos. Reinténtalo o introduce los modelos manualmente.",
  "provider.custom.discovery.unsupported":
    "Este servicio no permite listar modelos en esta dirección. Comprueba la URL o introduce un ID de modelo manualmente.",
  "provider.custom.discovery.saved": "Configuración de {provider} guardada",
  "provider.custom.discovery.savedDescription":
    "Selecciona un modelo para iniciar una tarea. No se han verificado la generación ni las llamadas a herramientas.",
  "provider.custom.discovery.intro": "Introduce la URL del servicio y la clave de API y obtén la lista de modelos.",
  "provider.custom.discovery.fetch": "Obtener modelos",
  "provider.custom.discovery.loading": "Obteniendo modelos…",
  "provider.custom.discovery.manual": "Introducir modelos manualmente",
  "provider.custom.discovery.advanced": "Configuración avanzada",
  "provider.custom.discovery.auto": "Automático",
  "provider.custom.discovery.save": "Guardar configuración",
  "provider.custom.discovery.search": "Buscar modelos",
  "provider.custom.discovery.success":
    "Lista de modelos recibida. El primer modelo está seleccionado; cambia la selección si lo necesitas. Esto no verifica la compatibilidad con generación o herramientas.",
  "provider.custom.discovery.auth": "Error de autenticación. Comprueba la clave de API y la dirección del servicio.",
  "provider.custom.discovery.rate":
    "Se alcanzó el límite de solicitudes. Inténtalo más tarde o introduce un ID de modelo manualmente.",
  "provider.custom.discovery.url":
    "Introduce una URL de servicio HTTP(S) válida sin credenciales, parámetros de consulta ni fragmentos.",
  "provider.custom.discovery.empty": "El servicio no devolvió modelos. Puedes introducir un ID de modelo manualmente.",
  "provider.custom.discovery.failed":
    "No se pudieron obtener los modelos. Comprueba la dirección y la red, reinténtalo o introduce los modelos manualmente. No se ha guardado ninguna configuración.",
  "provider.custom.discovery.choose": "Selecciona al menos un modelo o introduce un ID de modelo manualmente.",
  ...
  "dialog.provider.zaovra.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.zaovra.tagline": "Modelos optimizados y fiables",
  "dialog.provider.zaovraGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Zaovra",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Zaovra.",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.zaovraZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.zaovraZen.visit.prefix": "Visita ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Zaovra.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Zaovra.",
  ...
  "dialog.plugins.empty": "Plugins configurados en zaovra.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Zaovra se conecta esta app.",
  ...
  "wsl.onboarding.step.zaovra": "Zaovra",
  ...
  "wsl.onboarding.checkingZaovra": "Comprobando Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "Comprobando Zaovra en {{distro}}...",
  "wsl.onboarding.updatingZaovra": "Actualizando Zaovra...",
  "wsl.onboarding.updatingZaovraIn": "Actualizando Zaovra en {{distro}}...",
  "wsl.onboarding.updateZaovraIn": "Actualiza Zaovra en {{distro}}.",
  "wsl.onboarding.updateZaovra": "Actualizar Zaovra",
  "wsl.onboarding.zaovraReadyIn": "Zaovra está listo en {{distro}}.",
  "wsl.onboarding.zaovraReady": "Zaovra está listo.",
  "wsl.onboarding.installZaovraIn": "Instala Zaovra en {{distro}}.",
  "wsl.onboarding.installZaovra": "Instalar Zaovra",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Zaovra pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Zaovra no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Zaovra.",
  ...
  "toast.update.description": "Una nueva versión de Zaovra ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Zaovra",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (zaovra.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Zaovra no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Zaovra incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "app.name.desktop": "Zaovra Desktop",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Zaovra dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Zaovra",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Zaovra en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Zaovra sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Zaovra.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Zaovra",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Zaovra.",
