export const dict = {
  ...
  "desktop.menu.maximize": "最大化 / 元に戻す",
  ...
  "desktop.menu.fullScreen": "全画面表示の切り替え",
  "desktop.menu.documentation": "Zaovra ドキュメント",
  "desktop.menu.support": "サポートコミュニティ",
  "provider.custom.discovery.restart":
    "デスクトップアプリの接続コンポーネントが更新されました。モデルを取得するには Zaovra を閉じて開き直してください。入力内容は保持されます。",
  "provider.custom.discovery.environment":
    "ここでは環境変数からキーを読み取れません。モデル ID を手動で入力するか、キーを貼り付けて一覧を取得してください。",
  "provider.custom.discovery.timeout":
    "サービスが15秒以内に応答しませんでした。再試行するか、モデルを手動で入力してください。",
  "provider.custom.discovery.unsupported":
    "このサービスは、このアドレスでのモデル一覧取得に対応していません。URL を確認するか、モデル ID を手動で入力してください。",
  "provider.custom.discovery.saved": "{provider} の設定を保存しました",
  "provider.custom.discovery.savedDescription":
    "モデルを選択してタスクを開始してください。生成とツール呼び出しは未検証です。",
  "provider.custom.discovery.intro": "サービスの URL と API キーを入力して、モデル一覧を取得します。",
  "provider.custom.discovery.fetch": "モデルを取得",
  "provider.custom.discovery.loading": "モデルを取得中…",
  "provider.custom.discovery.manual": "モデルを手動で入力",
  "provider.custom.discovery.advanced": "詳細設定",
  "provider.custom.discovery.auto": "自動",
  "provider.custom.discovery.save": "設定を保存",
  "provider.custom.discovery.search": "モデルを検索",
  "provider.custom.discovery.success":
    "モデル一覧を取得しました。最初のモデルが選択されています。必要に応じて選択を変更してください。生成やツールへの対応を確認するものではありません。",
  "provider.custom.discovery.auth": "認証に失敗しました。API キーとサービスのアドレスを確認してください。",
  "provider.custom.discovery.rate":
    "リクエスト制限に達しました。後でもう一度試すか、モデル ID を手動で入力してください。",
  "provider.custom.discovery.url":
    "認証情報、クエリパラメータ、フラグメントを含まない有効な HTTP(S) サービス URL を入力してください。",
  "provider.custom.discovery.empty": "サービスからモデルが返されませんでした。モデル ID を手動で入力できます。",
  "provider.custom.discovery.failed":
    "モデルを取得できませんでした。アドレスとネットワークを確認して再試行するか、モデルを手動で入力してください。設定は保存されていません。",
  "provider.custom.discovery.choose": "モデルを1つ以上選択するか、モデル ID を手動で入力してください。",
  ...
  "dialog.provider.zaovra.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.zaovra.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.zaovraGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Zaovraが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Zaovraで{{provider}}モデルを使用します。",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.zaovraZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.zaovraZen.visit.prefix": " ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してZaovraで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Zaovraで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "zaovra.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するZaovraサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingZaovra": "Zaovraを確認中...",
  "wsl.onboarding.checkingZaovraIn": "{{distro}}内のZaovraを確認中...",
  "wsl.onboarding.updatingZaovra": "Zaovraを更新中...",
  "wsl.onboarding.updatingZaovraIn": "{{distro}}内のZaovraを更新中...",
  "wsl.onboarding.updateZaovraIn": "{{distro}}内のZaovraを更新してください。",
  "wsl.onboarding.updateZaovra": "Zaovraを更新",
  "wsl.onboarding.zaovraReadyIn": "{{distro}}内のZaovraの準備ができました。",
  "wsl.onboarding.zaovraReady": "Zaovraの準備ができました。",
  "wsl.onboarding.installZaovraIn": "{{distro}}にZaovraをインストールしてください。",
  "wsl.onboarding.installZaovra": "Zaovraをインストール",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovraがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ZaovraでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Zaovraをもう一度開いてください。",
  ...
  "toast.update.description": "Zaovraの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをZaovraチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (zaovra.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ZaovraはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Zaovraには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でZaovraサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Zaovraの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのZaovraの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Zaovraがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Zaovraのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Zaovra の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Zaovra は最新バージョンです。",
