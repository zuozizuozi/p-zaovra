export const dict = {
  ...
  "desktop.menu.minimize": "تصغير",
  "desktop.menu.maximize": "تكبير / استعادة",
  "desktop.menu.reload": "إعادة التحميل",
  "desktop.menu.devTools": "أدوات المطور",
  "desktop.menu.actualSize": "الحجم الفعلي",
  "desktop.menu.zoomIn": "تكبير العرض",
  "desktop.menu.zoomOut": "تصغير العرض",
  "desktop.menu.fullScreen": "تبديل ملء الشاشة",
  "desktop.menu.documentation": "وثائق Zaovra",
  "desktop.menu.support": "مجتمع الدعم",
  "provider.custom.discovery.restart":
    "تم تحديث مكوّن اتصال سطح المكتب. أغلق Zaovra وأعد فتحه لجلب النماذج. سيُحتفظ بإدخالك الحالي.",
  "provider.custom.discovery.environment":
    "لا يمكن قراءة مفاتيح متغيرات البيئة هنا. أدخل معرّفات النماذج يدويًا أو الصق مفتاحًا لجلب القائمة.",
  "provider.custom.discovery.timeout": "لم تستجب الخدمة خلال 15 ثانية. أعد المحاولة أو أدخل النماذج يدويًا.",
  "provider.custom.discovery.unsupported":
    "لا تدعم الخدمة سرد النماذج على هذا العنوان. تحقق من الرابط أو أدخل معرّف نموذج يدويًا.",
  "provider.custom.discovery.saved": "تم حفظ إعدادات {provider}",
  "provider.custom.discovery.savedDescription": "اختر نموذجًا لبدء مهمة. لم يتم التحقق من التوليد واستدعاء الأدوات.",
  "provider.custom.discovery.intro": "أدخل عنوان الخدمة ومفتاح API، ثم اجلب قائمة النماذج.",
  "provider.custom.discovery.fetch": "جلب النماذج",
  "provider.custom.discovery.loading": "جارٍ جلب النماذج…",
  "provider.custom.discovery.manual": "إدخال النماذج يدويًا",
  "provider.custom.discovery.advanced": "إعدادات متقدمة",
  "provider.custom.discovery.auto": "تلقائي",
  "provider.custom.discovery.save": "حفظ الإعدادات",
  "provider.custom.discovery.search": "البحث عن نماذج",
  "provider.custom.discovery.success":
    "تم استلام قائمة النماذج واختيار النموذج الأول؛ يمكنك تغيير الاختيار. لا يؤكد ذلك دعم التوليد أو الأدوات.",
  "provider.custom.discovery.auth": "فشلت المصادقة. تحقق من مفتاح API وعنوان الخدمة.",
  "provider.custom.discovery.rate": "تم تجاوز حد الطلبات. حاول لاحقًا أو أدخل معرّف نموذج يدويًا.",
  "provider.custom.discovery.url": "أدخل عنوان خدمة HTTP(S) صالحًا دون بيانات اعتماد أو معاملات استعلام أو أجزاء رابط.",
  "provider.custom.discovery.empty": "لم تُرجع الخدمة أي نماذج. يمكنك إدخال معرّف نموذج يدويًا.",
  "provider.custom.discovery.failed":
    "تعذر جلب النماذج. تحقق من العنوان والشبكة وأعد المحاولة، أو أدخل النماذج يدويًا. لم يتم حفظ أي إعدادات.",
  "provider.custom.discovery.choose": "اختر نموذجًا واحدًا على الأقل أو أدخل معرّف نموذج يدويًا.",
  ...
  "dialog.provider.zaovra.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.zaovra.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.zaovraGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Zaovra",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Zaovra.",
  ...
  "provider.connect.zaovraZen.line1":
    "يمنحك Zaovra Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.zaovraZen.visit.prefix": "قم بزيارة ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Zaovra.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Zaovra.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في zaovra.json",
  ...
  "dialog.server.description": "تبديل خادم Zaovra الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingZaovra": "جارٍ التحقق من Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "جارٍ التحقق من Zaovra في {{distro}}...",
  "wsl.onboarding.updatingZaovra": "جارٍ تحديث Zaovra...",
  "wsl.onboarding.updatingZaovraIn": "جارٍ تحديث Zaovra في {{distro}}...",
  "wsl.onboarding.updateZaovraIn": "حدّث Zaovra في {{distro}}.",
  "wsl.onboarding.updateZaovra": "تحديث Zaovra",
  "wsl.onboarding.zaovraReadyIn": "Zaovra جاهز في {{distro}}.",
  "wsl.onboarding.zaovraReady": "Zaovra جاهز.",
  "wsl.onboarding.installZaovraIn": "ثبّت Zaovra في {{distro}}.",
  "wsl.onboarding.installZaovra": "تثبيت Zaovra",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Zaovra من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Zaovra التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Zaovra.",
  ...
  "toast.update.description": "نسخة جديدة من Zaovra ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Zaovra",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (zaovra.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Zaovra لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Zaovra نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Zaovra داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Zaovra",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Zaovra على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Zaovra يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Zaovra.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Zaovra",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Zaovra.",
