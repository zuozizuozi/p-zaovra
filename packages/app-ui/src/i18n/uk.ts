export const dict = {
  ...
  "desktop.menu.selectAll": "Виділити все",
  "desktop.menu.newWindow": "Нове вікно",
  "desktop.menu.closeWindow": "Закрити вікно",
  "desktop.menu.minimize": "Згорнути",
  "desktop.menu.maximize": "Розгорнути / Відновити",
  "desktop.menu.reload": "Перезавантажити",
  "desktop.menu.devTools": "Інструменти розробника",
  "desktop.menu.actualSize": "Початковий розмір",
  "desktop.menu.zoomIn": "Збільшити",
  "desktop.menu.zoomOut": "Зменшити",
  "desktop.menu.fullScreen": "Перемкнути повний екран",
  "desktop.menu.documentation": "Документація Zaovra",
  "desktop.menu.support": "Спільнота підтримки",
  "provider.custom.discovery.restart":
    "Компонент підключення настільного застосунку оновлено. Закрийте й знову відкрийте Zaovra, щоб отримати моделі. Введені дані збережуться.",
  "provider.custom.discovery.environment":
    "Тут неможливо прочитати ключі зі змінних середовища. Введіть ідентифікатори моделей вручну або вставте ключ для отримання списку.",
  "provider.custom.discovery.timeout":
    "Сервіс не відповів протягом 15 секунд. Спробуйте ще раз або введіть моделі вручну.",
  "provider.custom.discovery.unsupported":
    "Сервіс не підтримує отримання списку моделей за цією адресою. Перевірте URL або введіть ідентифікатор моделі вручну.",
  "provider.custom.discovery.saved": "Налаштування {provider} збережено",
  "provider.custom.discovery.savedDescription":
    "Виберіть модель, щоб почати завдання. Генерацію та виклики інструментів ще не перевірено.",
  "provider.custom.discovery.intro": "Введіть URL сервісу та ключ API, а потім отримайте список моделей.",
  "provider.custom.discovery.fetch": "Отримати моделі",
  "provider.custom.discovery.loading": "Отримання моделей…",
  "provider.custom.discovery.manual": "Ввести моделі вручну",
  "provider.custom.discovery.advanced": "Розширені налаштування",
  "provider.custom.discovery.auto": "Автоматично",
  "provider.custom.discovery.save": "Зберегти налаштування",
  "provider.custom.discovery.search": "Пошук моделей",
  "provider.custom.discovery.success":
    "Список моделей отримано. Вибрано першу модель; за потреби змініть вибір. Це не підтверджує підтримку генерації чи інструментів.",
  "provider.custom.discovery.auth": "Помилка автентифікації. Перевірте ключ API та адресу сервісу.",
  "provider.custom.discovery.rate":
    "Досягнуто ліміту запитів. Спробуйте пізніше або введіть ідентифікатор моделі вручну.",
  "provider.custom.discovery.url":
    "Введіть коректну HTTP(S)-адресу сервісу без облікових даних, параметрів запиту та фрагментів.",
  "provider.custom.discovery.empty": "Сервіс не повернув жодної моделі. Можна ввести ідентифікатор моделі вручну.",
  "provider.custom.discovery.failed":
    "Не вдалося отримати моделі. Перевірте адресу й мережу, спробуйте знову або введіть моделі вручну. Налаштування не збережено.",
  "provider.custom.discovery.choose": "Виберіть принаймні одну модель або введіть ідентифікатор моделі вручну.",
  ...
  "dialog.provider.zaovra.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.zaovra.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.zaovraGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Zaovra",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Zaovra.",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.zaovraZen.visit.prefix": "Відвідайте ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Zaovra.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Zaovra.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в zaovra.json",
  ...
  "dialog.server.description": "Перемкніть сервер Zaovra, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingZaovra": "Перевірка Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "Перевірка Zaovra у {{distro}}...",
  "wsl.onboarding.updatingZaovra": "Оновлення Zaovra...",
  "wsl.onboarding.updatingZaovraIn": "Оновлення Zaovra у {{distro}}...",
  "wsl.onboarding.updateZaovraIn": "Оновіть Zaovra у {{distro}}.",
  "wsl.onboarding.updateZaovra": "Оновити Zaovra",
  "wsl.onboarding.zaovraReadyIn": "Zaovra готовий до роботи у {{distro}}.",
  "wsl.onboarding.zaovraReady": "Zaovra готовий до роботи.",
  "wsl.onboarding.installZaovraIn": "Встановіть Zaovra у {{distro}}.",
  "wsl.onboarding.installZaovra": "Встановити Zaovra",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Zaovra потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Zaovra не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Zaovra.",
  ...
  "toast.update.description": "Нова версія Zaovra ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Zaovra",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (zaovra.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Zaovra ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Zaovra містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Zaovra всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Zaovra",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Zaovra на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Zaovra використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Zaovra.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Zaovra",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Zaovra.",
