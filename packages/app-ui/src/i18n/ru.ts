export const dict = {
  ...
  "desktop.menu.maximize": "Развернуть / Восстановить",
  "desktop.menu.reload": "Перезагрузить",
  "desktop.menu.devTools": "Инструменты разработчика",
  "desktop.menu.actualSize": "Исходный размер",
  "desktop.menu.zoomIn": "Увеличить",
  "desktop.menu.zoomOut": "Уменьшить",
  "desktop.menu.fullScreen": "Переключить полный экран",
  "desktop.menu.documentation": "Документация Zaovra",
  "desktop.menu.support": "Сообщество поддержки",
  "provider.custom.discovery.restart":
    "Компонент подключения настольного приложения обновлён. Закройте и снова откройте Zaovra, чтобы получить модели. Введённые данные сохранятся.",
  "provider.custom.discovery.environment":
    "Здесь нельзя прочитать ключи из переменных окружения. Введите идентификаторы моделей вручную или вставьте ключ для получения списка.",
  "provider.custom.discovery.timeout":
    "Сервис не ответил в течение 15 секунд. Повторите попытку или введите модели вручную.",
  "provider.custom.discovery.unsupported":
    "Сервис не поддерживает получение списка моделей по этому адресу. Проверьте URL или введите идентификатор модели вручную.",
  "provider.custom.discovery.saved": "Настройки {provider} сохранены",
  "provider.custom.discovery.savedDescription":
    "Выберите модель, чтобы начать задачу. Генерация и вызовы инструментов ещё не проверены.",
  "provider.custom.discovery.intro": "Введите URL сервиса и ключ API, затем получите список моделей.",
  "provider.custom.discovery.fetch": "Получить модели",
  "provider.custom.discovery.loading": "Получение моделей…",
  "provider.custom.discovery.manual": "Ввести модели вручную",
  "provider.custom.discovery.advanced": "Расширенные настройки",
  "provider.custom.discovery.auto": "Автоматически",
  "provider.custom.discovery.save": "Сохранить настройки",
  "provider.custom.discovery.search": "Поиск моделей",
  "provider.custom.discovery.success":
    "Список моделей получен. Выбрана первая модель; при необходимости измените выбор. Это не подтверждает поддержку генерации или инструментов.",
  "provider.custom.discovery.auth": "Ошибка аутентификации. Проверьте ключ API и адрес сервиса.",
  "provider.custom.discovery.rate":
    "Достигнут лимит запросов. Попробуйте позже или введите идентификатор модели вручную.",
  "provider.custom.discovery.url":
    "Введите корректный HTTP(S)-адрес сервиса без учётных данных, параметров запроса и фрагментов.",
  "provider.custom.discovery.empty": "Сервис не вернул ни одной модели. Можно ввести идентификатор модели вручную.",
  "provider.custom.discovery.failed":
    "Не удалось получить модели. Проверьте адрес и сеть, повторите попытку или введите модели вручную. Настройки не сохранены.",
  "provider.custom.discovery.choose": "Выберите хотя бы одну модель или введите идентификатор модели вручную.",
  ...
  "dialog.provider.zaovra.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.zaovra.tagline": "Надежные оптимизированные модели",
  "dialog.provider.zaovraGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Zaovra",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Zaovra.",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  "provider.connect.zaovraZen.line2":
    "С одним API ключом вы получите доступ к таким моделям как Claude, GPT, Gemini, GLM и другим.",
  "provider.connect.zaovraZen.visit.prefix": "Посетите ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": " чтобы получить ваш API ключ.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Zaovra.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Zaovra.",
  ...
  "dialog.plugins.empty": "Плагины настроены в zaovra.json",
  ...
  "dialog.server.description": "Переключите сервер Zaovra к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingZaovra": "Проверка Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "Проверка Zaovra в {{distro}}...",
  "wsl.onboarding.updatingZaovra": "Обновление Zaovra...",
  "wsl.onboarding.updatingZaovraIn": "Обновление Zaovra в {{distro}}...",
  "wsl.onboarding.updateZaovraIn": "Обновите Zaovra в {{distro}}.",
  "wsl.onboarding.updateZaovra": "Обновить Zaovra",
  "wsl.onboarding.zaovraReadyIn": "Zaovra в {{distro}} готов к работе.",
  "wsl.onboarding.zaovraReady": "Zaovra готов к работе.",
  "wsl.onboarding.installZaovraIn": "Установите Zaovra в {{distro}}.",
  "wsl.onboarding.installZaovra": "Установить Zaovra",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Zaovra требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Zaovra не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Zaovra.",
  ...
  "toast.update.description": "Новая версия Zaovra ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Zaovra",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (zaovra.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Zaovra пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Zaovra включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Zaovra внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Zaovra",
  ...
  "settings.general.row.appearance.description": "Настройте как Zaovra выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Zaovra системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Zaovra.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Zaovra",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Zaovra.",
