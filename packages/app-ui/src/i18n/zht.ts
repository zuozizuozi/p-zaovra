...
export const dict = {
  ...
  "desktop.menu.maximize": "最大化 / 還原",
  "desktop.menu.reload": "重新載入",
  "desktop.menu.devTools": "開發者工具",
  "desktop.menu.actualSize": "實際大小",
  "desktop.menu.zoomIn": "放大",
  "desktop.menu.zoomOut": "縮小",
  "desktop.menu.fullScreen": "切換全螢幕",
  "desktop.menu.documentation": "造物文件",
  "desktop.menu.support": "支援社群",
  ...
  "dialog.provider.zaovra.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.zaovra.tagline": "可靠的優化模型",
  "dialog.provider.zaovraGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Zaovra 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Zaovra 中使用 {{provider}} 模型。",
  ...
  "provider.connect.zaovraZen.line1": "Zaovra Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.zaovraZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.zaovraZen.visit.prefix": "造訪 ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Zaovra 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 Zaovra 中使用 {{provider}} 模型。",
  ...
  "provider.custom.discovery.restart": "桌面連線元件已更新，請關閉並重新啟動 Zaovra 後取得模型。目前輸入已保留。",
  "provider.custom.discovery.environment": "此處無法讀取環境變數中的密鑰，請手動填寫模型 ID，或貼上 Key 後取得。",
  "provider.custom.discovery.timeout": "服務在 15 秒內未回應，請重試或手動填寫模型。",
  "provider.custom.discovery.unsupported": "此位址不支援取得模型清單，請檢查位址，或手動填寫模型 ID。",
  "provider.custom.discovery.saved": "{provider} 設定已儲存",
  "provider.custom.discovery.savedDescription": "可以選擇模型開始任務，尚未驗證生成和工具呼叫能力。",
  "provider.custom.discovery.intro": "填寫服務位址和 API Key，取得模型後選擇即可。",
  "provider.custom.discovery.fetch": "取得模型",
  "provider.custom.discovery.loading": "正在取得模型…",
  "provider.custom.discovery.manual": "手動填寫模型",
  "provider.custom.discovery.advanced": "進階設定",
  "provider.custom.discovery.auto": "自動產生",
  "provider.custom.discovery.save": "儲存設定",
  "provider.custom.discovery.search": "搜尋模型",
  "provider.custom.discovery.success": "已取得模型清單，預設選中第一項，可自行更換。尚未驗證生成和工具呼叫能力。",
  "provider.custom.discovery.auth": "驗證失敗，請檢查 API Key 和服務位址。",
  "provider.custom.discovery.rate": "請求過於頻繁，請稍後重試，或手動填寫模型 ID。",
  "provider.custom.discovery.url": "請填寫有效的 HTTP(S) 服務位址，不要包含帳密、查詢參數或錨點。",
  "provider.custom.discovery.empty": "服務未回傳模型，可手動填寫服務商提供的模型 ID。",
  "provider.custom.discovery.failed": "無法取得模型，請檢查位址與網路後重試，或手動填寫模型。設定尚未儲存。",
  "provider.custom.discovery.choose": "請至少選擇一個模型，或手動填寫模型 ID。",
  ...
  "provider.custom.models.name.placeholder": "選填，預設使用模型 ID",
  ...
  "prompt.toast.shellUnavailable.description": "SessionV2 暫不支援直接 Shell 模式，請讓 Agent 使用 bash 工具執行。",
  ...
  "dialog.plugins.empty": "在 zaovra.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Zaovra 伺服器。",
  ...
  "wsl.onboarding.checkingZaovra": "正在檢查 Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "正在檢查 {{distro}} 中的 Zaovra...",
  ...
  "wsl.onboarding.zaovraReadyIn": "{{distro}} 中的 Zaovra 已就緒。",
  "wsl.onboarding.zaovraReady": "Zaovra 已就緒。",
  "wsl.onboarding.installZaovraIn": "在 {{distro}} 中安裝 Zaovra。",
  "wsl.onboarding.installZaovra": "安裝 Zaovra",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "未安裝 Zaovra",
  ...
  "wsl.onboarding.wslUnavailable.description": "Zaovra 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Zaovra。",
  ...
  "toast.update.description": "Zaovra 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Zaovra 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (zaovra.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Zaovra 暫不支援 MCP 認證。',
  ...
  "session.message.waitingToJoin": "等待接入目前任務…",
  ...
  "sidebar.gettingStarted.line1": "Zaovra 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Zaovra 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Zaovra 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Zaovra 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Zaovra 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Zaovra 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Zaovra 啟動時自動檢查更新",
