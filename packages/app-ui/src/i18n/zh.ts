...
export const dict = {
  ...
  "session.outcome.execution.not-run": "检查未成功运行",
  "session.outcome.execution.invalid-report": "检查未生成有效报告",
  "session.outcome.execution.timeout": "检查超时",
  "session.outcome.superseded": "已由同范围的通过检查补充验证：",
  "session.outcome.coverage": "报告声明的断言覆盖：",
  "session.outcome.requirements": "尚未记录需求覆盖范围",
  ...
  "session.review.clearFilter": "清除筛选",
  "session.followupDock.hint": "排队消息会等当前任务结束后执行；“补充当前任务”会在下一个安全步骤生效。",
  "session.followupDock.remove": "删除排队消息",
  "session.permission.rememberScope": "“始终允许”会记住哪些范围？",
  "session.permission.rememberHint":
    "允许此项目今后匹配下列范围的操作，明确的拒绝规则仍然有效。“允许一次”只批准本次请求。",
  "session.activity.permission": "等待审批",
  "session.activity.question": "等待你回答",
  "session.activity.running": "执行中",
  "session.activity.shell": "命令尚未报告结束",
  "session.activity.error": "执行出错",
  "session.activity.unread": "有新回复",
  "session.activity.idle": "当前未执行",
  "session.activity.shellHint": "有命令尚未报告结束，请查看对话中的日志与结果；重新连接后，请先确认状态再重试。",
  "usage.title": "用量仪表盘",
  "usage.conversation": "本对话累计",
  "usage.lastTurn": "上一轮",
  "usage.sessionScope": "当前对话实际记录的 Token，不含独立子任务对话。点击查看包含全部对话的总仪表盘。",
  "usage.scope":
    "汇总当前服务器记录的全部用量，包含子任务对话。不包含其他应用或设备的消耗。缓存和推理 Token 不重复计数。",
  "usage.refresh": "刷新",
  "usage.loading": "正在读取用量…",
  "usage.error": "用量同步失败，请打开仪表盘重试",
  "usage.incomplete": "统计不完整",
  "usage.unreported": "次调用未返回完整用量",
  "usage.unknownSource": "来源未识别",
  "usage.input": "输入（非缓存）",
  "usage.output": "输出",
  "usage.reasoning": "推理",
  ...
  "usage.calls": "模型调用次数",
  "usage.ownBalance": "自有 Key 余额 / 费用",
  "usage.providerManaged": "请在供应商账户查看",
  "usage.planSpent": "官方套餐已扣额度",
  "usage.remaining": "套餐剩余额度",
  "usage.billingUnavailable": "尚未接入账户数据",
  "usage.billingNote":
    "上方 Token 是实际记录的使用量，不等于金额或套餐扣费。已扣额度和剩余额度以账户账单为准，未获取时不显示为 0。",
  "usage.updated": "最近同步",
  ...
  "model.source.ownEmpty": "暂无已配置的模型，连接你的模型服务即可开始。",
  "model.source.officialEmpty": "当前账户暂无可用的官方模型，可以先使用自有 Key。",
  "model.source.configure": "配置模型服务",
  "home.welcome.title": "今天，我们造点什么？",
  "home.welcome.description": "写下你的想法，选择项目，和造物一起开始。",
  "home.welcome.continue": "继续到会话",
  ...
  "desktop.menu.documentation": "造物文档",
  "desktop.menu.support": "支持社区",
  ...
  "dialog.provider.zaovra.note": "使用 Zaovra Zen 或 API 密钥连接",
  "dialog.provider.zaovra.tagline": "可靠的优化模型",
  "dialog.provider.zaovraGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Zaovra 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Zaovra 中使用 {{provider}} 模型。",
  ...
  "provider.connect.zaovraZen.line1": "Zaovra Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.zaovraZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.zaovraZen.visit.prefix": "访问 ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Zaovra 中使用 {{provider}} 模型。",
  ...
  "provider.custom.discovery.timeout": "服务在 15 秒内未响应，请重试或手动填写模型。",
  "provider.custom.discovery.unsupported": "该地址不支持获取模型列表，请检查地址，或手动填写模型 ID。",
  "provider.custom.discovery.saved": "{provider} 配置已保存",
  "provider.custom.discovery.savedDescription": "可以选择模型开始任务，尚未验证生成和工具调用能力。",
  "provider.custom.discovery.intro": "选择兼容协议，填写服务地址和 Key，然后获取并选择模型。",
  "provider.custom.discovery.fetch": "获取模型",
  "provider.custom.discovery.loading": "正在获取模型…",
  "provider.custom.discovery.manual": "手动填写模型",
  "provider.custom.discovery.advanced": "高级设置",
  "provider.custom.discovery.auto": "自动生成",
  "provider.custom.discovery.save": "保存配置",
  "provider.custom.discovery.search": "搜索模型",
  "provider.custom.discovery.success": "已获取模型列表，默认选中第一项，可自行更换。尚未验证生成和工具调用能力。",
  "provider.custom.discovery.auth": "认证失败，请检查 API Key 和服务地址。",
  "provider.custom.discovery.rate": "请求过于频繁，请稍后重试，也可以手动填写模型 ID。",
  "provider.custom.discovery.url": "请填写有效的 HTTP(S) 服务地址，不要包含账号密码、查询参数或锚点。",
  "provider.custom.discovery.empty": "服务未返回模型，可手动填写服务商提供的模型 ID。",
  "provider.custom.discovery.failed": "未能获取模型，请检查地址和网络后重试，或手动填写模型。配置尚未保存。",
  "provider.custom.discovery.choose": "请至少选择一个模型，或手动填写模型 ID。",
  "provider.custom.title": "自定义提供商",
  "provider.custom.description.prefix": "配置你的模型服务。请查看",
  ...
  "provider.custom.models.name.placeholder": "可选，默认使用模型 ID",
  ...
  "prompt.toast.shellUnavailable.description": "SessionV2 暂不支持直接 Shell 模式，请让 Agent 使用 bash 工具执行。",
  ...
  "dialog.plugins.empty": "在 zaovra.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Zaovra 服务器。",
  ...
  "wsl.onboarding.checkingZaovra": "正在检查 Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "正在检查 {{distro}} 中的 Zaovra...",
  "wsl.onboarding.updatingZaovra": "正在更新 Zaovra...",
  "wsl.onboarding.updatingZaovraIn": "正在更新 {{distro}} 中的 Zaovra...",
  "wsl.onboarding.updateZaovraIn": "更新 {{distro}} 中的 Zaovra。",
  "wsl.onboarding.updateZaovra": "更新 Zaovra",
  "wsl.onboarding.zaovraReadyIn": "{{distro}} 中的 Zaovra 已就绪。",
  "wsl.onboarding.zaovraReady": "Zaovra 已就绪。",
  "wsl.onboarding.installZaovraIn": "在 {{distro}} 中安装 Zaovra。",
  "wsl.onboarding.installZaovra": "安装 Zaovra",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "未安装 Zaovra",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Zaovra 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Zaovra 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Zaovra。",
  ...
  "toast.update.description": "Zaovra 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Zaovra 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (zaovra.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Zaovra 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Zaovra 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Zaovra 服务器。",
  ...
  "settings.general.row.language.description": "更改 Zaovra 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Zaovra 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Zaovra 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Zaovra 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Zaovra 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Zaovra。",
  ...
  "settings.providers.custom.description": "连接 OpenAI 兼容、Anthropic 或 Gemini 协议的服务。",
  ...
  "dialog.provider.custom.label": "自定义模型服务",
