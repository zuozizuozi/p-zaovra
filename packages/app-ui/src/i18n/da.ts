export const dict = {
  ...
  "desktop.menu.redo": "Annuller fortryd",
  "desktop.menu.cut": "Klip",
  "desktop.menu.copy": "Kopiér",
  "desktop.menu.paste": "Indsæt",
  "desktop.menu.delete": "Slet",
  "desktop.menu.selectAll": "Markér alt",
  "desktop.menu.newWindow": "Nyt vindue",
  "desktop.menu.closeWindow": "Luk vindue",
  "desktop.menu.minimize": "Minimer",
  "desktop.menu.maximize": "Maksimer / Gendan",
  "desktop.menu.reload": "Genindlæs",
  "desktop.menu.devTools": "Udviklerværktøjer",
  "desktop.menu.actualSize": "Faktisk størrelse",
  "desktop.menu.zoomIn": "Zoom ind",
  "desktop.menu.zoomOut": "Zoom ud",
  "desktop.menu.fullScreen": "Skift fuld skærm",
  "desktop.menu.documentation": "Zaovra-dokumentation",
  "desktop.menu.support": "Supportfællesskab",
  "provider.custom.discovery.restart":
    "Skrivebordsappens forbindelseskomponent er blevet opdateret. Luk og åbn Zaovra igen for at hente modeller. Dine indtastninger bevares.",
  "provider.custom.discovery.environment":
    "Nøgler fra miljøvariabler kan ikke læses her. Indtast model-id'er manuelt, eller indsæt en nøgle for at hente listen.",
  "provider.custom.discovery.timeout":
    "Tjenesten svarede ikke inden for 15 sekunder. Prøv igen, eller indtast modeller manuelt.",
  "provider.custom.discovery.unsupported":
    "Tjenesten understøtter ikke visning af modeller på denne adresse. Kontrollér URL'en, eller indtast et model-id manuelt.",
  "provider.custom.discovery.saved": "Konfigurationen for {provider} er gemt",
  "provider.custom.discovery.savedDescription":
    "Vælg en model for at starte en opgave. Generering og værktøjskald er ikke blevet kontrolleret.",
  "provider.custom.discovery.intro": "Indtast tjenestens URL og API-nøgle, og hent derefter modellisten.",
  "provider.custom.discovery.fetch": "Hent modeller",
  "provider.custom.discovery.loading": "Henter modeller…",
  "provider.custom.discovery.manual": "Indtast modeller manuelt",
  "provider.custom.discovery.advanced": "Avancerede indstillinger",
  "provider.custom.discovery.auto": "Automatisk",
  "provider.custom.discovery.save": "Gem konfiguration",
  "provider.custom.discovery.search": "Søg i modeller",
  "provider.custom.discovery.success":
    "Modellisten er modtaget. Den første model er valgt; skift valget efter behov. Dette kontrollerer ikke understøttelse af generering eller værktøjer.",
  "provider.custom.discovery.auth": "Godkendelse mislykkedes. Kontrollér API-nøglen og tjenestens adresse.",
  "provider.custom.discovery.rate": "Anmodningsgrænsen er nået. Prøv igen senere, eller indtast et model-id manuelt.",
  "provider.custom.discovery.url":
    "Indtast en gyldig HTTP(S)-URL til tjenesten uden loginoplysninger, forespørgselsparametre eller fragmenter.",
  "provider.custom.discovery.empty": "Tjenesten returnerede ingen modeller. Du kan indtaste et model-id manuelt.",
  "provider.custom.discovery.failed":
    "Modellerne kunne ikke hentes. Kontrollér adressen og netværket, prøv igen, eller indtast modeller manuelt. Ingen konfiguration er gemt.",
  "provider.custom.discovery.choose": "Vælg mindst én model, eller indtast et model-id manuelt.",
  ...
  "dialog.provider.zaovra.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.zaovra.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.zaovraGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Zaovra",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Zaovra.",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.zaovraZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.zaovraZen.visit.prefix": "Besøg ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Zaovra.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Zaovra.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i zaovra.json",
  ...
  "dialog.server.description": "Skift hvilken Zaovra-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingZaovra": "Tjekker Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "Tjekker Zaovra i {{distro}}...",
  "wsl.onboarding.updatingZaovra": "Opdaterer Zaovra...",
  "wsl.onboarding.updatingZaovraIn": "Opdaterer Zaovra i {{distro}}...",
  "wsl.onboarding.updateZaovraIn": "Opdater Zaovra i {{distro}}.",
  "wsl.onboarding.updateZaovra": "Opdater Zaovra",
  "wsl.onboarding.zaovraReadyIn": "Zaovra er klar i {{distro}}.",
  "wsl.onboarding.zaovraReady": "Zaovra er klar.",
  "wsl.onboarding.installZaovraIn": "Installer Zaovra i {{distro}}.",
  "wsl.onboarding.installZaovra": "Installer Zaovra",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Zaovra kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Zaovra kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Zaovra igen.",
  ...
  "toast.update.description": "En ny version af Zaovra ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Zaovra-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (zaovra.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Zaovra understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Zaovra inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Zaovra-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Zaovra",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Zaovra ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Zaovra følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Zaovra er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Zaovra starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Zaovra.",
