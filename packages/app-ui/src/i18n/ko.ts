export const dict = {
  ...
  "desktop.menu.maximize": "최대화 / 복원",
  "desktop.menu.reload": "새로 고침",
  "desktop.menu.devTools": "개발자 도구",
  "desktop.menu.actualSize": "실제 크기",
  "desktop.menu.zoomIn": "확대",
  "desktop.menu.zoomOut": "축소",
  "desktop.menu.fullScreen": "전체 화면 전환",
  "desktop.menu.documentation": "Zaovra 문서",
  "desktop.menu.support": "지원 커뮤니티",
  "provider.custom.discovery.restart":
    "데스크톱 앱의 연결 구성 요소가 업데이트되었습니다. 모델을 가져오려면 Zaovra를 닫았다가 다시 여세요. 현재 입력은 유지됩니다.",
  "provider.custom.discovery.environment":
    "여기서는 환경 변수의 키를 읽을 수 없습니다. 모델 ID를 직접 입력하거나 키를 붙여넣어 목록을 가져오세요.",
  "provider.custom.discovery.timeout":
    "서비스가 15초 안에 응답하지 않았습니다. 다시 시도하거나 모델을 직접 입력하세요.",
  "provider.custom.discovery.unsupported":
    "이 서비스는 이 주소에서 모델 목록 조회를 지원하지 않습니다. URL을 확인하거나 모델 ID를 직접 입력하세요.",
  "provider.custom.discovery.saved": "{provider} 설정 저장됨",
  "provider.custom.discovery.savedDescription":
    "모델을 선택하여 작업을 시작하세요. 생성 및 도구 호출은 검증되지 않았습니다.",
  "provider.custom.discovery.intro": "서비스 URL과 API 키를 입력한 다음 모델 목록을 가져오세요.",
  "provider.custom.discovery.fetch": "모델 가져오기",
  "provider.custom.discovery.loading": "모델 가져오는 중…",
  "provider.custom.discovery.manual": "모델 직접 입력",
  "provider.custom.discovery.advanced": "고급 설정",
  "provider.custom.discovery.auto": "자동",
  "provider.custom.discovery.save": "설정 저장",
  "provider.custom.discovery.search": "모델 검색",
  "provider.custom.discovery.success":
    "모델 목록을 받았습니다. 첫 번째 모델이 선택되어 있으며 필요에 따라 변경할 수 있습니다. 생성 또는 도구 지원 여부를 검증한 것은 아닙니다.",
  "provider.custom.discovery.auth": "인증에 실패했습니다. API 키와 서비스 주소를 확인하세요.",
  "provider.custom.discovery.rate": "요청 한도에 도달했습니다. 나중에 다시 시도하거나 모델 ID를 직접 입력하세요.",
  "provider.custom.discovery.url":
    "인증 정보, 쿼리 매개변수, 프래그먼트가 없는 유효한 HTTP(S) 서비스 URL을 입력하세요.",
  "provider.custom.discovery.empty": "서비스가 모델을 반환하지 않았습니다. 모델 ID를 직접 입력할 수 있습니다.",
  "provider.custom.discovery.failed":
    "모델을 가져올 수 없습니다. 주소와 네트워크를 확인하고 다시 시도하거나 모델을 직접 입력하세요. 설정은 저장되지 않았습니다.",
  "provider.custom.discovery.choose": "모델을 하나 이상 선택하거나 모델 ID를 직접 입력하세요.",
  ...
  "dialog.provider.zaovra.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.zaovra.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.zaovraGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "dialog.model.unpaid.freeModels.title": "Zaovra에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 Zaovra에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  "provider.connect.zaovraZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.zaovraZen.visit.prefix": "다음 ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  "provider.connect.oauth.code.visit.prefix": "다음 ",
  "provider.connect.oauth.code.visit.link": "이 링크",
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 Zaovra에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Zaovra에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "zaovra.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 Zaovra 서버를 전환합니다.",
  ...
  "toast.update.description": "Zaovra의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 Zaovra 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(zaovra.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: Zaovra는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "Zaovra에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 Zaovra 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "Zaovra 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Zaovra가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Zaovra가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Zaovra 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Zaovra를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Zaovra를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingZaovra": "Zaovra 확인 중...",
  "wsl.onboarding.checkingZaovraIn": "{{distro}}에서 Zaovra 확인 중...",
  "wsl.onboarding.updatingZaovra": "Zaovra 업데이트 중...",
  "wsl.onboarding.updatingZaovraIn": "{{distro}}에서 Zaovra 업데이트 중...",
  "wsl.onboarding.updateZaovraIn": "{{distro}}에서 Zaovra를 업데이트하세요.",
  "wsl.onboarding.updateZaovra": "Zaovra 업데이트",
  "wsl.onboarding.zaovraReadyIn": "{{distro}}에서 Zaovra를 사용할 준비가 되었습니다.",
  "wsl.onboarding.zaovraReady": "Zaovra가 준비되었습니다.",
  "wsl.onboarding.installZaovraIn": "{{distro}}에 Zaovra를 설치하세요.",
  "wsl.onboarding.installZaovra": "Zaovra 설치",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Zaovra에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "Zaovra에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 Zaovra를 다시 여세요.",
