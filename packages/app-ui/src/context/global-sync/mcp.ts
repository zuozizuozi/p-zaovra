import type { V2McpResourcesResponse, V2McpStatusResponse } from "@zaovra-ai/sdk/v2/client"

export type McpStatus = V2McpStatusResponse["data"][string]
export type McpResource = V2McpResourcesResponse["data"][string]
