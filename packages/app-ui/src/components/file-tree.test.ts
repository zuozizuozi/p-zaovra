...
beforeAll(async () => {
  ...
  mock.module("@zaovra-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@zaovra-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@zaovra-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@zaovra-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
