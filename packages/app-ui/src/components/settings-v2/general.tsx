...
import { Switch } from "@zaovra-ai/ui/v2/switch-v2"
import { TextInputV2 } from "@zaovra-ai/ui/v2/text-input-v2"
import { useTheme, type ColorScheme } from "@zaovra-ai/ui/theme/context"
      ...
      <SettingsListV2>
        ...
        >
          <div data-action="settings-auto-accept-permissions">
            <Switch hideLabel checked={accepting()} disabled={!dir()} onChange={toggleAccept}>
        ...
        <Show when={mobile() && import.meta.env.VITE_ZAOVRA_CHANNEL !== "prod"}>
          <SettingsRowV2
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <Link class="settings-v2-link" href="https://zaovra.com/docs/themes/">
        ...
        <SettingsListV2>
          ...
          >
            <div data-action="settings-pinch-zoom">
              <Switch hideLabel checked={pinchZoom.latest} onChange={onPinchZoomChange}>
