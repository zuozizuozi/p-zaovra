...
Reduce reactive misuse across `packages/app-ui`.

---

## Context

This work targets `packages/app-ui/src`, which currently has 101 `createEffect` calls across 37 files.
...
- Do not attempt a repo-wide cleanup outside `packages/app-ui`
...
- `packages/app-ui/src/pages/session.tsx:141`
- `packages/app-ui/src/pages/layout.tsx:557`
- `packages/app-ui/src/components/terminal.tsx:261`
- `packages/app-ui/src/components/session/session-header.tsx:309`
...
- `packages/app-ui/src/pages/session.tsx:325`
- `packages/app-ui/src/pages/session.tsx:336`
- `packages/app-ui/src/pages/session.tsx:477`
- `packages/app-ui/src/pages/session.tsx:869`
- `packages/app-ui/src/pages/session.tsx:963`
- `packages/app-ui/src/pages/session/message-timeline.tsx:149`
- `packages/app-ui/src/context/file.tsx:100`
...
- `packages/app-ui/src/pages/layout.tsx:484`
- `packages/app-ui/src/pages/layout.tsx:652`
- `packages/app-ui/src/pages/layout.tsx:776`
- `packages/app-ui/src/pages/layout.tsx:1489`
- `packages/app-ui/src/pages/layout.tsx:1519`
- `packages/app-ui/src/components/file-tree.tsx:328`
- `packages/app-ui/src/pages/session/terminal-panel.tsx:55`
- `packages/app-ui/src/context/global-sync.tsx:148`
- Duplicated trigger sets in:
  - `packages/app-ui/src/pages/session/review-tab.tsx:122`
  - `packages/app-ui/src/pages/session/review-tab.tsx:130`
  - `packages/app-ui/src/pages/session/review-tab.tsx:138`
  - `packages/app-ui/src/pages/session/file-tabs.tsx:367`
  - `packages/app-ui/src/pages/session/file-tabs.tsx:378`
  - `packages/app-ui/src/pages/session/file-tabs.tsx:389`
  - `packages/app-ui/src/pages/session/use-session-hash-scroll.ts:144`
  - `packages/app-ui/src/pages/session/use-session-hash-scroll.ts:149`
  - `packages/app-ui/src/pages/session/use-session-hash-scroll.ts:167`
...
- DOM/editor sync in `packages/app-ui/src/components/prompt-input.tsx:690`
- Scroll sync in `packages/app-ui/src/pages/session.tsx:685`
- Scroll/hash sync in `packages/app-ui/src/pages/session/use-session-hash-scroll.ts:149`
- External sync in:
  - `packages/app-ui/src/context/language.tsx:207`
  - `packages/app-ui/src/context/settings.tsx:110`
  - `packages/app-ui/src/context/sdk.tsx:26`
- Polling in:
  - `packages/app-ui/src/components/status-popover.tsx:59`
  - `packages/app-ui/src/components/dialog-select-server.tsx:273`
...
- Normalize tabs at write boundaries and remove `packages/app-ui/src/pages/session.tsx:141`
- Stop syncing `workspaceOrder` in `packages/app-ui/src/pages/layout.tsx:557`
- Make prompt slash filtering reactive so `packages/app-ui/src/components/prompt-input.tsx:652` can be removed
...
- Split mixed-responsibility effect in `packages/app-ui/src/pages/layout.tsx:1489`
...
- Remove child-store hydration mirrors in `packages/app-ui/src/context/global-sync/child-store.ts:184`, `:190`, `:193`
- Simplify mirror logic in `packages/app-ui/src/context/global-sync.tsx:130`, `:138`
- Revisit `packages/app-ui/src/context/layout.tsx:424` if it still mirrors instead of deriving
...
- The effect at `packages/app-ui/src/pages/session.tsx:141` is removed
...
- The effect at `packages/app-ui/src/pages/layout.tsx:557` is removed
...
- `packages/app-ui/src/context/global-sync.tsx:130`
- `packages/app-ui/src/context/global-sync.tsx:138`
- `packages/app-ui/src/context/global-sync.tsx:148`
- `packages/app-ui/src/context/global-sync/child-store.ts:184`
- `packages/app-ui/src/context/global-sync/child-store.ts:190`
- `packages/app-ui/src/context/global-sync/child-store.ts:193`
- `packages/app-ui/src/context/layout.tsx:424`
...
- The effect at `packages/app-ui/src/context/file.tsx:100` is removed
...
- `packages/app-ui/src/pages/layout.tsx:1489`
- Related event-driven effects near `packages/app-ui/src/pages/layout.tsx:484`, `:652`, `:776`, `:1519`
...
- The effect at `packages/app-ui/src/pages/layout.tsx:1489` no longer mixes unrelated responsibilities
...
- `packages/app-ui/src/components/prompt-input.tsx:652`
- Keep `packages/app-ui/src/components/prompt-input.tsx:690` as needed
...
- The effect at `packages/app-ui/src/components/prompt-input.tsx:652` is removed
