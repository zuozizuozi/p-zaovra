---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala zaovra.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

zaovra zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie zaovra uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI zaovra, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do zaovra. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij zaovra. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `zaovra.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Zaovra czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `zaovra.default`.
