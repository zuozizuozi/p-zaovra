---
title: IDE
description: The Zaovra extension for VS Code, Cursor, and other IDEs
---

Zaovra integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `zaovra` in the terminal to get started.
...
To install Zaovra on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `zaovra` - the extension installs automatically
...
Search for **Zaovra** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `zaovra` in the integrated terminal.
