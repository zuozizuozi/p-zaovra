...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Zaovra:
...
- ระดับผู้ใช้ (Global): `~/.config/zaovra/commands/`
- ระดับโปรเจ็กต์: `.zaovra/commands/`
...
Zaovra มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
