...
Kreiraj `.zaovra/commands/test.md`:
...
Možete dodati prilagođene komande kroz Zaovra konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Zaovra [config](/docs/config):
...
- Globalno: `~/.config/zaovra/commands/`
- Po projektu: `.zaovra/commands/`
...
Zaovra uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
