...
Agentferdigheter lar Zaovra oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
zaovra søker etter disse stedene:

- Prosjektkonfigurasjon: `.zaovra/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/zaovra/skills/<name>/SKILL.md`
...
For prosjektlokale stier går zaovra opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.zaovra/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/zaovra/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.zaovra/skills/git-release/SKILL.md` slik:
...
zaovra viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `zaovra.json`:
...
**For innebygde agenter** (i `zaovra.json`):
