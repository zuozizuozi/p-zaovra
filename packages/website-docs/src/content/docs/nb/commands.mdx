...
Opprett `.zaovra/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Zaovra-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Zaovra [config](/docs/config):
...
Zaovra inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
