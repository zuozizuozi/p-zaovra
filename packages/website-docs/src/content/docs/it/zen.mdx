---
title: Zen
description: Lista curata di modelli fornita da Zaovra.
---
...
Zaovra Zen è un elenco di modelli testati e verificati forniti dal team di Zaovra.

Zen funziona come qualsiasi altro provider in Zaovra. Accedi a Zaovra Zen e ottieni
...
Zaovra Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Zaovra Zen funziona come qualsiasi altro provider in Zaovra.

1. Accedi a **<a href={console}>Zaovra Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Zaovra Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Zaovra
usa il formato `zaovra/<model-id>`. Per esempio, per GPT 5.5, useresti
`zaovra/gpt-5.5` nella tua config.
...
- DeepSeek V4 Flash Free è disponibile su Zaovra per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su Zaovra per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- North Mini Code Free è disponibile su Zaovra per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su Zaovra per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Zaovra per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Zaovra.
