---
title: LSP-servere
description: Zaovra integreres med dine LSP-servere.
---

Zaovra kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Zaovra leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `ZAOVRA_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og zaovra åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din zaovra-konfiguration.
