export const dict = {
  "app.title": "Rankingi użycia modeli AI | Zaovra Data",
  "app.description":
    "Przeglądaj użycie Zaovra Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Zaovra Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Zaovra na GitHub",
  "header.github": "GitHub",
  "header.tryZaovra": "Wypróbuj Zaovra",
  ...
  "footer.homeAria": "Strona główna Zaovra",
  ...
  "home.topModelsDescription": "Użycie modeli w Zaovra Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Zaovra Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Zaovra Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Zaovra Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Zaovra.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Zaovra",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Zaovra",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Zaovra z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Zaovra Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Zaovra Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Zaovra Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Zaovra Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Zaovra Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Zaovra Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Zaovra Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Zaovra Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Zaovra Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Zaovra Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Zaovra Go.",
  ...
  "model.geoDescription": "Tokeny modelu Zaovra Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Zaovra Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Zaovra Go.",
