export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Zaovra Data",
  "app.description":
    "Zaovra Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Zaovra Data logosu",
  ...
  "header.githubAria": "GitHub'da Zaovra'a yıldız ver",
  "header.github": "GitHub",
  "header.tryZaovra": "Zaovra'u dene",
  ...
  "footer.homeAria": "Zaovra ana sayfası",
  ...
  "home.topModelsDescription": "Zaovra Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Zaovra Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Zaovra Data",
  "lab.description":
    "Zaovra Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Zaovra kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Zaovra'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Zaovra kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Zaovra token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Zaovra Data",
  "model.description":
    "{{model}} için Zaovra Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Zaovra Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Zaovra Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Zaovra Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Zaovra Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Zaovra Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Zaovra Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Zaovra Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Zaovra Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Zaovra Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Zaovra Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Zaovra Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Zaovra Go token hacmine göre yakındaki modeller.",
