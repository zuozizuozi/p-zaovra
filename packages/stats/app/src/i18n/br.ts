export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Zaovra Data",
  "app.description":
    "Explore o uso do Zaovra Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Zaovra Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Zaovra no GitHub",
  "header.github": "GitHub",
  "header.tryZaovra": "Experimente o Zaovra",
  ...
  "footer.homeAria": "Início do Zaovra",
  ...
  "modal.title": "Newsletter do Zaovra",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Zaovra Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Zaovra Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Zaovra Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Zaovra Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Zaovra.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Zaovra",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Zaovra",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Zaovra nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Zaovra Data",
  "model.description":
    "Veja dados de uso de {{model}} no Zaovra Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Zaovra Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Zaovra Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Zaovra Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Zaovra Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Zaovra Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Zaovra Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Zaovra Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Zaovra Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Zaovra Go.",
  ...
  "model.geoDescription": "Tokens do modelo Zaovra Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do Zaovra Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Zaovra Go.",
