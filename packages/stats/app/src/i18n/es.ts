export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | Zaovra Data",
  "app.description":
    "Explora el uso de Zaovra Go en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de Zaovra Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a Zaovra en GitHub",
  "header.github": "GitHub",
  "header.tryZaovra": "Probar Zaovra",
  ...
  "footer.homeAria": "Inicio de Zaovra",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en Zaovra Go.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de Zaovra Go por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | Zaovra Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en Zaovra Go, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de Zaovra.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en Zaovra",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de Zaovra",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de Zaovra durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | Zaovra Data",
  "model.description":
    "Consulta datos de uso de {{model}} en Zaovra Go, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de Zaovra Go aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de Zaovra Go de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de Zaovra Go de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de Zaovra Go en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de Zaovra Go, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de Zaovra Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de Zaovra Go durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de Zaovra Go durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de Zaovra Go.",
  ...
  "model.geoDescription": "Tokens del modelo de Zaovra Go usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de Zaovra Go coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de Zaovra Go.",
