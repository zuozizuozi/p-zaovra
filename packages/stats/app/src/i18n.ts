...
const en = {
  "app.title": "AI Model Usage Rankings | Zaovra Data",
  "app.description":
    "Explore Zaovra Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Zaovra Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Zaovra on GitHub",
  "header.github": "GitHub",
  "header.tryZaovra": "Try Zaovra",
  ...
  "home.topModelsDescription": "Usage of models across Zaovra Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Zaovra Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Zaovra Data",
  "lab.description":
    "Compare {{lab}} models used in Zaovra Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Zaovra usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Zaovra",
  ...
  "lab.shareOfUsage": "{{share}} of recent Zaovra usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Zaovra Data",
  "model.description":
    "View {{model}} Zaovra Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Zaovra Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Zaovra Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Zaovra Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Zaovra Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Zaovra Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Zaovra Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Zaovra Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Zaovra Go token volume.",
