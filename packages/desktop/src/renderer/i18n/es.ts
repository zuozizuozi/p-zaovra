export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Zaovra",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Zaovra. ¿Quieres instalarla y reiniciar?",
