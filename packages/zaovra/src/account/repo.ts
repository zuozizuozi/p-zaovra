...
import { AccountStateTable, AccountTable } from "@zaovra-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@zaovra/AccountRepo") {}
