...
import { makeGlobalNode, Node } from "@zaovra-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<ZaovraAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<ZaovraAssistantMessage, "role"> &
  Partial<Pick<ZaovraAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@zaovra/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@zaovra/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@zaovra/ACPUsage") {}
