...
>()("@zaovra/ExperimentalHttpApiWorkspaceRouteContext") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.ZAOVRA_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.ZAOVRA_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-zaovra-directory"] || process.cwd()
}
