...
import { normalizePromptContent } from "@zaovra-ai/tui/editor"
...
import { ZAOVRA_BASE_MODE, useBindings } from "@zaovra-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Zaovra" } satisfies SlashOption,
    ]
