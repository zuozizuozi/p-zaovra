...
//
// The saved variant persists across sessions in ~/.local/state/zaovra/model.json
...
class Service extends Context.Service<Service, VariantService>()("@zaovra/RunVariant") {}
