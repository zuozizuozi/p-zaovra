...
import { ProjectDirectoryTable, ProjectTable } from "@zaovra-ai/core/project/sql"
import { ProjectDirectories } from "@zaovra-ai/core/project/directories"
...
export class Service extends Context.Service<Service, Interface>()("@zaovra/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.ZAOVRA_FAKE_VCS)
