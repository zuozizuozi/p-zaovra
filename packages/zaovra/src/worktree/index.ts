...
import { path } from "@zaovra-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@zaovra-ai/core/project"
...
import { WorktreeEvent } from "@zaovra-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@zaovra/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `zaovra/${name}`
