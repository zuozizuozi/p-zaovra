...
import { httpClient, path } from "@zaovra-ai/core/effect/app-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@zaovra/SkillDiscovery") {}
