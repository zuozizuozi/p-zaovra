...
import type * as SDK from "@zaovra-ai/sdk/v2"
...
import { SessionShareTable } from "@zaovra-ai/core/share/sql"
...
const disabled = process.env["ZAOVRA_DISABLE_SHARE"] === "true" || process.env["ZAOVRA_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@zaovra/ShareNext") {}
