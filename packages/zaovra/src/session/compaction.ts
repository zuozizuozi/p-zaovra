...
import { buildPrompt } from "@zaovra-ai/core/session/compaction"
import { SessionCompactionEvent } from "@zaovra-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@zaovra/SessionCompaction") {}
