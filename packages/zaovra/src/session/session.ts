...
import type { ProviderMetadata, Usage } from "@zaovra-ai/llm"
...
import { locationServiceMapLayer } from "@zaovra-ai/core/location-services"
...
import { PartTable, SessionTable } from "@zaovra-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@zaovra-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".zaovra", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@zaovra/Session") {}
