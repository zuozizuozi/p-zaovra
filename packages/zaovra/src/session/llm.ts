...
import { llmClient } from "@zaovra-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@zaovra-ai/llm"
import { LLMClient } from "@zaovra-ai/llm/route"
import type { LLMClientService } from "@zaovra-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@zaovra/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via zaovra's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @zaovra-ai/llm. It
