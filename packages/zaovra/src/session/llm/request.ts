...
const USER_AGENT = `zaovra/${InstallationVersion}`
...
export const prepare = Effect.fn("LLMRequestPrep.prepare")(function* (input: PrepareInput) {
  ...
  const zaovraProjectID = input.model.providerID.startsWith("zaovra")
  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("zaovra")
        ? {
            ...(zaovraProjectID ? { "x-zaovra-project": zaovraProjectID } : {}),
            "x-zaovra-session": input.sessionID,
            "x-zaovra-request": input.user.id,
            "x-zaovra-client": input.flags.client,
