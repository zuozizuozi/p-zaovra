import type { JsonSchema, LLMRequest, ProviderMetadata } from "@zaovra-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@zaovra-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @zaovra-ai/llm request objects from zaovra's session/AI SDK-shaped data.
  return LLM.request({
