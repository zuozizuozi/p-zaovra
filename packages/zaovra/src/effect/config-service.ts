 ...
 *   "@zaovra/ServerAuthConfig",
 *   {
 *     password: Config.string("ZAOVRA_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("ZAOVRA_SERVER_USERNAME").pipe(Config.withDefault("zaovra")),
 *   },
 * ) {}
 *
