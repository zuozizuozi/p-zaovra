...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/zaovra.git")).toEqual({ owner: "sst", repo: "zaovra" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/zaovra")).toEqual({ owner: "sst", repo: "zaovra" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/zaovra.git")).toEqual({ owner: "sst", repo: "zaovra" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/zaovra")).toEqual({ owner: "sst", repo: "zaovra" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/zaovra.git")).toEqual({ owner: "sst", repo: "zaovra" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/zaovra")).toEqual({ owner: "sst", repo: "zaovra" })
})
