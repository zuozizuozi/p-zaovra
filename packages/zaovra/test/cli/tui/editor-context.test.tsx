...
import { EditorContextProvider, useEditorContext, type EditorIntegration } from "@zaovra-ai/tui/context/editor"
import { tmpdir } from "../../fixture/fixture"
import { FakeWebSocket } from "../../lib/websocket"
import { TestTuiContexts } from "../../fixture/tui-environment"
import { discoverEditorConnection } from "@zaovra-ai/tui/editor"

const originalClaudePort = process.env.CLAUDE_CODE_SSE_PORT
const originalZaovraPort = process.env.ZAOVRA_EDITOR_SSE_PORT

afterEach(() => {
  process.env.CLAUDE_CODE_SSE_PORT = originalClaudePort
  process.env.ZAOVRA_EDITOR_SSE_PORT = originalZaovraPort
})
...
test("useEditorContext reconnect switches editor server by session directory", async () => {
  ...
  process.env.ZAOVRA_EDITOR_SSE_PORT = undefined
...
test("useEditorContext connects with ZAOVRA_EDITOR_SSE_PORT", async () => {
  await using tmp = await tmpdir()
  process.env.CLAUDE_CODE_SSE_PORT = undefined
  process.env.ZAOVRA_EDITOR_SSE_PORT = "4020"
