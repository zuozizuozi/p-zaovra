...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips zaovra-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-zaovra-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-zaovra-directory")).toBeNull()
      expect(result.get("x-zaovra-workspace")).toBeNull()
