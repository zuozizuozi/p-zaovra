...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips zaovra-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-zaovra-directory"]).toBeUndefined()
      expect(forwarded["x-zaovra-workspace"]).toBeUndefined()
