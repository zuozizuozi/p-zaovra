...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ZAOVRA_CALLER", () => {
    process.env["ZAOVRA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ZAOVRA_CALLER", () => {
    process.env["ZAOVRA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ZAOVRA_CALLER", () => {
    process.env["ZAOVRA_CALLER"] = "unknown"
