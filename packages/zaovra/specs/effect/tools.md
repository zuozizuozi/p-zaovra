...
Practical reference for the current tool-migration state in `packages/zaovra`.
...
Tool tests should use the existing Effect helpers in `packages/zaovra/test/lib/effect.ts`:
