---
title: SDK
description: Typsicherer JS-Client fuer den zaovra-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das zaovra JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und zaovra programmatisch steuern.
...
`zaovra.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn zaovra bereits laeuft, kannst du nur einen Client erstellen und verbinden:
