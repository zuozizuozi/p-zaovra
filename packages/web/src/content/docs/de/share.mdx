---
title: Teilen
description: Teile Zaovra-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Zaovra-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Zaovra Folgendes:
...
Zaovra hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Zaovra den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`zaovra.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du zaovra in deiner Organisation einsetzt.
