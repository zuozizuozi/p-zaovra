---
title: TUI
description: Korištenje korisničkog interfejsa Zaovra terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Zaovra pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Zaovra pokreće TUI za trenutni direktorij.
...
Kada koristite Zaovra TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Zaovra. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Zaovra. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `zaovra.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Zaovra čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `zaovra.default`.
