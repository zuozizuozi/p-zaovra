---
title: SDK
description: Cliente JS seguro em tipos para o servidor zaovra.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/v2/gen/types.gen.ts`

O SDK JS/TS do zaovra fornece um cliente seguro em tipos para interagir com o servidor.
Use-o para construir integrações e controlar o zaovra programaticamente.
...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `zaovra.json`, mas você pode substituir ou adicionar configuração inline:
...
Se você já tem uma instância do zaovra em execução, pode criar uma instância de cliente para se conectar a ela:
