...
The `mcp auth` command will open your browser for authorization. After you authorize, Zaovra will store the tokens securely in `~/.local/share/zaovra/mcp-auth.json`.
