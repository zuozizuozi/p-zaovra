---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące zaovra.
---

Funkcja udostępniania zaovra umożliwia tworzenie publicznych linków do konwersacji zaovra, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, zaovra:
...
zaovra obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie zaovra korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `zaovra.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu zaovra w Twojej organizacji.
