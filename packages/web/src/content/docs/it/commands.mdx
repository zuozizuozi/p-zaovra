...
Puoi aggiungere comandi personalizzati tramite la config di Zaovra o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Zaovra:
...
- Globale: `~/.config/zaovra/commands/`
- Per progetto: `.zaovra/commands/`
...
zaovra include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
