...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في zaovra.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في zaovra مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.zaovra/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/zaovra/tools/`.
