...
Du kan tilføje brugerdefinerede kommandoer gennem Zaovra-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Zaovra [config](/docs/config):
...
- Globalt: `~/.config/zaovra/commands/`
- Pr. projekt: `.zaovra/commands/`
...
zaovra indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
