---
title: Özel Araçlar
description: LLM'un zaovra'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. zaovra'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.zaovra/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/zaovra/tools/` içine yerleştirerek.
