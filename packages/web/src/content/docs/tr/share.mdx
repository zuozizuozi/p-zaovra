---
title: Paylasim
description: zaovra konusmalarini genel baglantilarla paylasin.
---

zaovra'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda zaovra:
...
zaovra, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak zaovra manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `zaovra.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda zaovra kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
