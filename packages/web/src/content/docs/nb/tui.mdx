---
title: TUI
description: Bruke zaovra-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Zaovra gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Zaovra starter TUI for gjeldende katalog.
...
Når du bruker Zaovra TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Zaovra. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Zaovra. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `zaovra.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Zaovra venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `zaovra.default`.
