...
description: Lag verktøy som LLM kan kalle inn Zaovra.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Zaovra sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.zaovra/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/zaovra/tools/`.
