...
Puede agregar comandos personalizados a través de la configuración Zaovra o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Zaovra [config](/docs/config):
...
zaovra incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
