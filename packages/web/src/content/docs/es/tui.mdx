---
title: TUI
description: Usando la interfaz de usuario del terminal Zaovra.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Zaovra proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Zaovra se inicia TUI para el directorio actual.
...
Cuando utilice Zaovra TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Zaovra. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Zaovra. _Alias_: `/quit`, `/q`
...
Esto es independiente de `zaovra.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera Zaovra después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `zaovra.default`.
