...
declare const ZAOVRA_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof ZAOVRA_CLI_NAME === "string" ? ZAOVRA_CLI_NAME : "zaovra", {
  description: "Zaovra 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
