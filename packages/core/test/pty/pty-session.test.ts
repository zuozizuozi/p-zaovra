...
import { Pty } from "@zaovra-ai/core/pty"
import type { PtyID } from "@zaovra-ai/core/pty/schema"
...
const createPty = Effect.fn("PtySessionTest.createPty")(function* (command: string, args: string[] = []) {
  ...
  return yield* Effect.acquireRelease(
    pty.create({ command, args, cwd: "/tmp", env: { TERM: "xterm-256color", ZAOVRA_TERMINAL: "1" } }),
