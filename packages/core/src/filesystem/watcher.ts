...
import { FileSystemWatcher } from "@zaovra-ai/schema/filesystem-watcher"
...
declare const ZAOVRA_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof ZAOVRA_LIBC === "undefined" ? undefined : ZAOVRA_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@zaovra/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.ZAOVRA_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.ZAOVRA_EXPERIMENTAL_FILEWATCHER)) {
