...
export class Service extends Context.Service<Service, Interface>()("@zaovra/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.ZAOVRA_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
