...
export const migrations = (
  await Promise.all([
    ...
    import("./migration/20260805191955_work_graph"),
    import("./migration/20260806021945_work_lease"),
    import("./migration/20260806070515_work_handoff"),
    import("./migration/20260806073810_work_handoff_routing"),
    import("./migration/20260806081044_work_organization_memory"),
    import("./migration/20260806083425_work_worker_placement"),
    import("./migration/20260806090711_work_worker_credentials"),
    import("./migration/20260806180810_work_remote_jobs"),
    import("./migration/20260806193759_work_remote_artifacts"),
    import("./migration/20260806211353_work_worker_runtime"),
    import("./migration/20260806222919_work_controller_cluster"),
