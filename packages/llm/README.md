...
Schema-first LLM core for zaovra. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@zaovra-ai/llm"
import { OpenAI } from "@zaovra-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@zaovra-ai/llm/providers"
