export const dict = {
  ...
  "notFound.title": "Not Found | zaovra",
  "notFound.heading": "404 - Page Not Found",
  "notFound.home": "Home",
  "notFound.docs": "Docs",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "zaovra logo light",
  "notFound.logoDarkAlt": "zaovra logo dark",
  ...
  "app.meta.description": "Zaovra - The open source coding agent.",

  "home.title": "Zaovra | The open source AI coding agent",

  "temp.title": "zaovra | AI coding agent built for the terminal",
  ...
  "temp.feature.zen.afterLink": "provided by zaovra",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "zaovra TUI with the tokyonight theme",
  "temp.screenshot.alt": "zaovra TUI with tokyonight theme",
  "temp.logoLightAlt": "zaovra logo light",
  "temp.logoDarkAlt": "zaovra logo dark",
  ...
  "home.what.title": "What is Zaovra?",
  "home.what.body": "Zaovra is an open source agent that helps you write code in your terminal, IDE, or desktop.",
  ...
  "home.growth.body":
    "With over <strong>{{stars}}</strong> GitHub stars, <strong>{{contributors}}</strong> contributors, and over <strong>{{commits}}</strong> commits, Zaovra is used and trusted by over <strong>{{monthlyUsers}}</strong> developers every month.",
  ...
  "home.privacy.body":
    "Zaovra does not store any of your code or context data, so that it can operate in privacy sensitive environments.",
  "home.privacy.learnMore": "Learn more about",
  "home.privacy.link": "privacy",

  "home.faq.q1": "What is Zaovra?",
  "home.faq.a1":
    "Zaovra is an open source agent that helps you write and run code with any AI model. It's available as a terminal-based interface, desktop app, or IDE extension.",
  "home.faq.q2": "How do I use Zaovra?",
  "home.faq.a2.before": "The easiest way to get started is to read the",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Do I need extra AI subscriptions to use Zaovra?",
  "home.faq.a3.p1":
    "Not necessarily, Zaovra comes with a set of free models that you can use without creating an account.",
  ...
  "home.faq.a3.p3":
    "While we encourage users to use Zen, Zaovra also works with all popular providers such as OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "You can even connect your",
  "home.faq.a3.p4.localLink": "local models",
  "home.faq.q4": "Can I use my existing AI subscriptions with Zaovra?",
  "home.faq.a4.p1":
    "Yes, Zaovra supports subscription plans from all major providers. You can use your Claude Pro/Max, ChatGPT Plus/Pro, or GitHub Copilot subscriptions.",
  "home.faq.q5": "Can I only use Zaovra in the terminal?",
  "home.faq.a5.beforeDesktop": "Not anymore! Zaovra is now available as an app for your",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "and",
  "home.faq.a5.web": "web",
  "home.faq.q6": "How much does Zaovra cost?",
  "home.faq.a6":
    "Zaovra is 100% free to use. It also comes with a set of free models. There might be additional costs if you connect any other provider.",
  ...
  "home.faq.q8": "Is Zaovra open source?",
  "home.faq.a8.p1": "Yes, Zaovra is fully open source. The source code is public on",
  ...
  "home.zenCta.body":
    "Zen gives you access to a handpicked set of AI models that Zaovra has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality across providers, use validated models that work.",
  "home.zenCta.link": "Learn about Zen",

  "zen.title": "Zaovra Zen | A curated set of reliable optimized models for coding agents",
  "zen.hero.title": "Reliable optimized models for coding agents",
  "zen.hero.body":
    "Zen gives you access to a curated set of AI models that Zaovra has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality, use validated models that work.",

  "zen.faq.q1": "What is Zaovra Zen?",
  "zen.faq.a1":
    "Zen is a curated set of AI models tested and benchmarked for coding agents created by the team behind Zaovra.",
  ...
  "zen.faq.a3":
    "Zen is not for profit. Zen passes through the costs from the model providers to you. The higher Zen's usage the more Zaovra can negotiate better rates and pass those to you.",
  ...
  "zen.faq.a4.p3": "To cover costs, Zaovra adds only a small payment processing fee of $1.23 per $20 balance top-up.",
  ...
  "zen.faq.a8":
    "While Zen works great with Zaovra, you can use Zen with any agent. Follow the setup instructions in your preferred coding agent.",
  ...
  "zen.problem.subtitle": "We're fixing this for everyone, not just Zaovra users.",
  ...
  "zen.how.body": "While we suggest you use Zen with Zaovra, you can use Zen with any agent.",
  ...
  "go.title": "Zaovra Go | Low cost coding models for everyone",
  ...
  "go.problem.body":
    "We're focused on bringing the Zaovra experience to as many people as possible. Zaovra Go is a low cost subscription: $5 for your first month, then $10/month. It provides generous limits and reliable access to the most capable open source models.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go starts at $5 for your first month, then $10/month. You can use it with Zaovra or any agent.",
  ...
  "zen.api.error.trialEnded":
    "Free promotion has ended for {{model}}. You can continue using the model by subscribing to Zaovra Go - {{link}}",

  "black.meta.title": "Zaovra Black | Access all the world's best coding models",
  "black.meta.description": "Get access to Claude, GPT, Gemini and more with Zaovra Black subscription plans.",
  "black.hero.title": "Access all the world's best coding models",
  "black.hero.subtitle": "Including Claude, GPT, Gemini and more",
  "black.title": "Zaovra Black | Pricing",
  ...
  "black.workspace.title": "Zaovra Black | Select Workspace",
  "black.workspace.selectPlan": "Select a workspace for this plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Subscribe to Zaovra Black",
  ...
  "black.subscribe.success.title": "You're on the Zaovra Black waitlist",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with zaovra whenever you want.",
  ...
  "workspace.newUser.step.login.after": "and select zaovra",
  "workspace.newUser.step.pasteKey": "Paste your API key",
  "workspace.newUser.step.models.before": "Start zaovra and run",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing zaovra services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create an zaovra Gateway API key",
  ...
  "workspace.black.subscription.message": "You are subscribed to Zaovra Black for ${{plan}} per month.",
  ...
  "workspace.black.waitlist.joined": "You are on the waitlist for the ${{plan}} per month Zaovra Black plan.",
  "workspace.black.waitlist.ready": "We're ready to enroll you into the ${{plan}} per month Zaovra Black plan.",
  ...
  "workspace.lite.subscription.message": "You are subscribed to Zaovra Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Select "Zaovra Go" as the provider in your zaovra configuration to use Go models.',
  ...
  "workspace.lite.black.message":
    "You're currently subscribed to Zaovra Black or on the waitlist. Please unsubscribe first if you'd like to switch to Go.",
  "workspace.lite.other.message":
    "Another member in this workspace is already subscribed to Zaovra Go. Only one member per workspace can subscribe.",
  "workspace.lite.promo.description":
    "Zaovra Go starts at {{price}}, then $10/month, and provides reliable access to popular open coding models with generous usage limits.",
  ...
  "download.title": "Zaovra | Download",
  "download.meta.description": "Download Zaovra for macOS, Windows, and Linux",
  "download.hero.title": "Download Zaovra Desktop",
  ...
  "download.faq.a3.beforeLocal":
    "Not necessarily, but probably. You'll need an AI subscription if you want to connect Zaovra to a paid provider, although you can work with",
  "download.faq.a3.localLink": "local models",
  "download.faq.a3.afterLocal.beforeZen": "for free. While we encourage users to use",
  "download.faq.a3.afterZen": ", Zaovra works with all popular providers such as OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "Zaovra is 100% free to use.",
  "download.faq.a5.p2.beforeZen":
    "Any additional costs will come from your subscription to a model provider. While Zaovra works with any model provider, we recommend using",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Your data and information is only stored when you create sharable links in Zaovra.",
  "download.faq.a6.p2.beforeShare": "Learn more about",
  "download.faq.a6.shareLink": "share pages",

  "enterprise.title": "Zaovra | Enterprise solutions for your organisation",
  "enterprise.meta.description": "Contact Zaovra for enterprise solutions",
  "enterprise.hero.title": "Your code is yours",
  "enterprise.hero.body1":
    "Zaovra operates securely inside your organization with no data or context stored and no licensing restrictions or ownership claims. Start a trial with your team, then deploy it across your organization by integrating it with your SSO and internal AI gateway.",
  ...
  "enterprise.faq.q1": "What is Zaovra Enterprise?",
  "enterprise.faq.a1":
  ...
  "enterprise.faq.q2": "How do I get started with Zaovra Enterprise?",
  "enterprise.faq.a2":
    "Simply start with an internal trial with your team. Zaovra by default does not store your code or context data, making it easy to get started. Then contact us to discuss pricing and implementation options.",
  ...
  "enterprise.faq.q4": "Is my data secure with Zaovra Enterprise?",
  "enterprise.faq.a4":
  ...
  "brand.title": "Zaovra | Brand",
  "brand.meta.description": "Zaovra brand guidelines",
  "brand.heading": "Brand guidelines",
  "brand.subtitle": "Resources and assets to help you work with the Zaovra brand.",
  "brand.downloadAll": "Download all assets",

  "changelog.title": "Zaovra | Changelog",
  "changelog.meta.description": "Zaovra release notes and changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "New updates and improvements to Zaovra",
  ...
  "home.next.metaTitle": "Zaovra — AI coding, grounded in your workspace",
  "home.next.metaDescription":
    "A local-first desktop AI coding workspace with BYOK, reviewable changes, an integrated terminal, and an in-development WorkGraph preview.",
  "home.next.nav.ariaLabel": "Homepage navigation",
  "home.next.nav.product": "Product",
  "home.next.nav.byok": "BYOK",
  "home.next.nav.workgraph": "WorkGraph preview",
  "home.next.action.download": "Download",
  "home.next.action.downloadBeta": "Download desktop beta",
  "home.next.action.github": "View on GitHub",
  "home.next.action.providerDocs": "Explore provider setup",
  "home.next.action.source": "Browse the source",
  "home.next.hero.eyebrow": "Desktop app · Beta",
  "home.next.hero.title": "AI coding, grounded in your workspace.",
  "home.next.hero.body":
    "Explore a codebase, plan changes, run commands, and review the result from one desktop workspace—using your own model credentials or an active Zaovra subscription.",
  "home.next.hero.platforms": "Available for macOS, Windows, and Linux",
  "home.next.proof.ariaLabel": "Zaovra product principles",
  "home.next.proof.byok.title": "Bring your own key",
  "home.next.proof.byok.body": "Connect provider credentials you already control.",
  "home.next.proof.workspace.title": "Real workspace",
  "home.next.proof.workspace.body": "Work with project files, sessions, tools, and terminals in context.",
  "home.next.proof.review.title": "Reviewable changes",
  "home.next.proof.review.body": "Inspect file changes and execution output before moving on.",
  "home.next.workflow.kicker": "One connected workspace",
  "home.next.workflow.title": "Everything the work needs, within reach.",
  "home.next.workflow.body":
    "Workspace context, provider choice, sessions, tools, and review stay visible around the work.",
  "home.next.workflow.explore.title": "Explore",
  "home.next.workflow.explore.body": "Load workspace context and understand the relevant code.",
  "home.next.workflow.plan.title": "Plan",
  "home.next.workflow.plan.body": "Turn the request into concrete edits and checks.",
  "home.next.workflow.execute.title": "Execute",
  "home.next.workflow.execute.body": "Edit files and run commands with permission controls.",
  "home.next.workflow.review.title": "Review",
  "home.next.workflow.review.body": "Inspect diffs, terminal output, and the final result.",
  "home.next.workbench.kicker": "Desktop workbench",
  "home.next.workbench.title": "The work stays visible.",
  "home.next.workbench.body":
    "Sessions, file changes, terminal output, editor services, and permission requests share one focused desktop surface.",
  "home.next.workbench.sessions.title": "Sessions and workspaces",
  "home.next.workbench.sessions.body": "Keep multiple sessions and projects organized without losing their working context.",
  "home.next.workbench.review.title": "File review",
  "home.next.workbench.review.body": "Read the actual diff, move through changed files, and keep review close to the conversation.",
  "home.next.workbench.tools.title": "Terminal, LSP, and permissions",
  "home.next.workbench.tools.body": "See command output and language-server state, with explicit controls around sensitive actions.",
  "home.next.byok.kicker": "Model choice is yours",
  "home.next.byok.title": "Bring the providers you already use.",
  "home.next.byok.body":
    "BYOK is a first-class path in Zaovra. Connect your own credentials and keep provider access and billing with the account you control.",
  "home.next.byok.account": "No Zaovra account is required for local Agent use with BYOK.",
  "home.next.byok.providers": "Connect supported provider credentials from the desktop app.",
  "home.next.byok.endpoint": "Configure custom or local OpenAI-compatible endpoints.",
  "home.next.workgraph.badge": "Preview · In development",
  "home.next.workgraph.kicker": "What we are building",
  "home.next.workgraph.title": "Durable work beyond a single chat turn.",
  "home.next.workgraph.body":
    "WorkGraph is an active development preview for turning a goal into tasks, attempts, repairs, and evidence. Availability and behavior may change before release.",
  "home.next.workgraph.goal": "Structure a goal into explicit tasks and dependencies.",
  "home.next.workgraph.control": "Pause, resume, repair, or replan work at clear boundaries.",
  "home.next.workgraph.evidence": "Keep attempts and evidence attached to the work they support.",
  "home.next.open.kicker": "Local-first and open",
  "home.next.open.title": "Use Zaovra on infrastructure you understand.",
  "home.next.open.workspace.title": "Grounded in your workspace",
  "home.next.open.workspace.body":
    "The desktop app works against your selected workspace and can connect to a local or self-run Zaovra server.",
  "home.next.open.source.title": "MIT licensed",
  "home.next.open.source.body": "Read the implementation, adapt it, and contribute through the public repository.",
  "home.next.access.kicker": "Two access paths",
  "home.next.access.title": "Choose how models connect.",
  "home.next.access.body": "The desktop workflow stays the same. The model access and billing boundary is your choice.",
  "home.next.access.byok.label": "Recommended for control",
  "home.next.access.byok.title": "Bring your own key",
  "home.next.access.byok.body": "Use credentials for supported providers or an OpenAI-compatible endpoint.",
  "home.next.access.byok.point1": "No Zaovra account required for local BYOK use",
  "home.next.access.byok.point2": "Does not consume Zaovra-managed inference",
  "home.next.access.subscription.label": "Managed access",
  "home.next.access.subscription.title": "Zaovra subscription",
  "home.next.access.subscription.body": "Use Zaovra-managed model access after signing in with an active subscription.",
  "home.next.access.subscription.point1": "Active subscription required",
  "home.next.access.subscription.point2": "No plan names, quotas, or pricing implied here",
  "home.next.faq.kicker": "Product boundaries",
  "home.next.faq.title": "Straight answers.",
  "home.next.faq.account.q": "Do I need a Zaovra account to use BYOK?",
  "home.next.faq.account.a":
    "No. You can use the local Agent with your own provider credentials without a Zaovra account, and those requests do not consume Zaovra-managed inference.",
  "home.next.faq.local.q": "Can I connect a local model server?",
  "home.next.faq.local.a":
    "You can configure a custom or local OpenAI-compatible endpoint. Exact model behavior depends on that endpoint and model.",
  "home.next.faq.workgraph.q": "Is WorkGraph available now?",
  "home.next.faq.workgraph.a":
    "WorkGraph is currently an in-development preview. Its interface, behavior, and release availability may change.",
  "home.next.faq.desktop.q": "What does the desktop app include?",
  "home.next.faq.desktop.a":
    "The beta brings sessions, workspace context, file review, an integrated terminal, LSP status, and permission controls into one interface.",
  "home.next.faq.open.q": "Is Zaovra open source?",
  "home.next.faq.open.a": "Yes. The repository is public and licensed under the MIT License.",
  "home.next.download.kicker": "Start in your workspace",
  "home.next.download.title": "Bring Zaovra to the code you are working on.",
  "home.next.download.body": "Download the desktop beta or install the command-line tool with the method you prefer.",
  "home.next.install.ariaLabel": "Install Zaovra",
} as const
