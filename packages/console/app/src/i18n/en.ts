export const dict = {
  ...
  "home.next.metaTitle": "Zaovra — third-generation desktop coding agent",
  "home.next.metaDescription":
    "A desktop coding agent with account-based access, BYOK, managed model memberships, reviewable changes, and durable work.",
  ...
  "home.next.hero.title": "Third-generation coding work, grounded in your workspace.",
  "home.next.hero.body":
    "Sign in to explore a codebase, plan changes, run commands, and review the result—using your own model credentials or a Zaovra membership.",
  "home.next.hero.platforms": "Windows available first · macOS coming soon",
  ...
  "home.next.byok.account": "A Zaovra account is required; a paid membership is not.",
  ...
  "home.next.open.kicker": "Desktop-first and inspectable",
  "home.next.open.title": "Keep the work visible from request to review.",
  "home.next.open.workspace.title": "Grounded in your workspace",
  "home.next.open.workspace.body":
    "The desktop app works against your selected workspace with explicit permissions and reviewable output.",
  "home.next.open.source.title": "Desktop-first workflow",
  "home.next.open.source.body": "Work in real projects with terminal context, file review, and clear execution boundaries.",
  ...
  "home.next.access.byok.point1": "Zaovra account required; no paid membership required",
  ...
  "home.next.access.subscription.point2": "Choose Starter, Pro, or Max on the pricing page",
  ...
  "home.next.faq.account.a":
    "Yes. Every desktop session requires a Zaovra account, but BYOK does not require a paid membership and does not consume Zaovra-managed inference.",
  ...
  "home.next.faq.open.a": "No. Zaovra is a commercial desktop product and is not presented as an open-source project.",
  "home.next.download.kicker": "Start in your workspace",
  "home.next.download.title": "Bring Zaovra to the code you are working on.",
  "home.next.download.body": "Download Zaovra for Windows. The macOS release is coming soon.",
