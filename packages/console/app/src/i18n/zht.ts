...
export const dict = {
  ...
  "notFound.title": "找不到頁面 | Zaovra",
  "notFound.heading": "404 - 找不到頁面",
  "notFound.home": "首頁",
  "notFound.docs": "文件",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "zaovra 淺色標誌",
  "notFound.logoDarkAlt": "zaovra 深色標誌",
  ...
  "app.meta.description": "Zaovra - 開源編碼代理。",

  "home.title": "Zaovra | 開源 AI 編碼代理",

  "temp.title": "Zaovra | 專為終端打造的 AI 編碼代理",
  ...
  "temp.feature.zen.afterLink": "由 Zaovra 提供",
  "temp.feature.models.beforeLink": "透過",
  "temp.feature.models.afterLink": "支援 75+ 家 LLM 供應商，包括本地模型",
  "temp.screenshot.caption": "使用 tokyonight 主題的 Zaovra TUI",
  "temp.screenshot.alt": "使用 tokyonight 主題的 Zaovra TUI",
  "temp.logoLightAlt": "zaovra 淺色標誌",
  "temp.logoDarkAlt": "zaovra 深色標誌",
  ...
  "home.what.title": "什麼是 Zaovra？",
  "home.what.body": "Zaovra 是一個開源代理，幫助你在終端、IDE 或桌面端編寫程式碼。",
  ...
  "home.growth.body":
    "擁有超過 <strong>{{stars}}</strong> 個 GitHub Star、<strong>{{contributors}}</strong> 位貢獻者以及超過 <strong>{{commits}}</strong> 次提交，Zaovra 每月被超過 <strong>{{monthlyUsers}}</strong> 名開發者使用並信賴。",
  "home.growth.githubStars": "GitHub Star",
  "home.growth.contributors": "貢獻者",
  "home.growth.monthlyDevs": "每月活躍開發者",

  "home.privacy.title": "隱私優先",
  "home.privacy.body": "Zaovra 不儲存你的程式碼或上下文資料，因此可以在注重隱私的環境中運作。",
  "home.privacy.learnMore": "了解更多關於",
  "home.privacy.link": "隱私",

  "home.faq.q1": "什麼是 Zaovra？",
  "home.faq.a1":
    "Zaovra 是一個開源代理，幫助你使用任意 AI 模型編寫並執行程式碼。它提供終端介面、桌面應用程式或 IDE 擴充功能。",
  "home.faq.q2": "如何使用 Zaovra？",
  "home.faq.a2.before": "最簡單的方式是先閱讀",
  "home.faq.a2.link": "入門介紹",
  "home.faq.q3": "使用 Zaovra 需要額外的 AI 訂閱嗎？",
  "home.faq.a3.p1": "不一定。Zaovra 自帶一組免費模型，無需建立帳號即可使用。",
  "home.faq.a3.p2.beforeZen": "此外，你可以透過建立",
  "home.faq.a3.p2.afterZen": "帳號使用常見的編碼模型。",
  "home.faq.a3.p3": "我們鼓勵使用 Zen，但 Zaovra 也支援 OpenAI、Anthropic、xAI 等主流供應商。",
  "home.faq.a3.p4.beforeLocal": "你還可以連接你的",
  "home.faq.a3.p4.localLink": "本地模型",
  "home.faq.q4": "可以使用我現有的 AI 訂閱嗎？",
  "home.faq.a4.p1":
    "可以。Zaovra 支援主流供應商的訂閱方案，包括 Claude Pro/Max、ChatGPT Plus/Pro 與 GitHub Copilot。",
  "home.faq.q5": "Zaovra 只能在終端中使用嗎？",
  "home.faq.a5.beforeDesktop": "不再是了！Zaovra 現在也提供",
  "home.faq.a5.desktop": "桌面端",
  "home.faq.a5.and": "與",
  "home.faq.a5.web": "網頁端",
  "home.faq.q6": "Zaovra 價格如何？",
  "home.faq.a6": "Zaovra 100% 免費使用。它也自帶一組免費模型。如果你連接其他供應商，可能會產生額外費用。",
  ...
  "home.faq.q8": "Zaovra 是開源的嗎？",
  "home.faq.a8.p1": "是的，Zaovra 完全開源。原始碼公開在",
  "home.faq.a8.p2": "並採用",
  ...
  "home.zenCta.body":
    "Zen 提供一組精選的 AI 模型，這些模型是 Zaovra 為了編碼代理專門測試與評測過的。無需擔心不同供應商之間效能與品質參差不齊，使用經過驗證的模型即可。",
  "home.zenCta.link": "了解 Zen",

  "zen.title": "Zaovra Zen | 專為編碼代理精選的可靠最佳化模型",
  "zen.hero.title": "專為編碼代理提供的可靠最佳化模型",
  "zen.hero.body":
    "Zen 提供一組精選的 AI 模型，這些模型是 Zaovra 為了編碼代理專門測試與評測過的。無需擔心效能與品質參差不齊，使用經過驗證的模型即可。",

  "zen.faq.q1": "什麼是 Zaovra Zen？",
  "zen.faq.a1": "Zen 是由 Zaovra 團隊打造、專為編碼代理測試與評測的 AI 模型精選集合。",
  "zen.faq.q2": "是什麼讓 Zen 更準確？",
  "zen.faq.a2": "Zen 只提供專為編碼代理測試與評測的模型。你不會用奶油刀切牛排，也別用糟糕的模型來寫程式。",
  "zen.faq.q3": "Zen 更便宜嗎？",
  "zen.faq.a3":
    "Zen 不以營利為目的。Zen 會把模型供應商的成本原樣轉給你。Zen 的使用量越高，Zaovra 就越能談到更好的價格並把優惠讓利給你。",
  ...
  "zen.faq.a4.p3": "為了覆蓋成本，Zaovra 只會收取很小的支付處理費：每次儲值 $20 會額外收取 $1.23。",
  "zen.faq.q5": "資料與隱私如何？",
  ...
  "zen.faq.a8":
    "Zen 與 Zaovra 搭配得很好，但你也可以在任何代理中使用 Zen。請在你偏好的編碼代理中按照設定說明進行配置。",
  ...
  "zen.problem.subtitle": "我們正在為所有人解決此問題，而不僅僅是 Zaovra 使用者。",
  ...
  "zen.how.body": "雖然我們建議你將 Zen 與 Zaovra 一起使用，但你可以將 Zen 與任何代理一起使用。",
  ...
  "go.problem.body":
    "我們致力於將 Zaovra 體驗帶給盡可能多的人。Zaovra Go 是一款低成本訂閱服務：首月 $5，之後 $10/月。它提供充裕的額度，並讓您能可靠地使用最強大的開源模型。",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go 起價為首月 $5，之後 $10/月。您可以將其與 Zaovra 或任何代理搭配使用。",
  ...
  "zen.api.error.trialEnded": "{{model}} 的限免活动已結束。您可以訂閱 Zaovra Go 繼續使用該模型 - {{link}}",

  "black.meta.title": "Zaovra Black | 存取全球最佳編碼模型",
  "black.meta.description": "透過 Zaovra Black 訂閱方案存取 Claude、GPT、Gemini 等模型。",
  "black.hero.title": "存取全球最佳編碼模型",
  "black.hero.subtitle": "包括 Claude、GPT、Gemini 等",
  "black.title": "Zaovra Black | 定價",
  ...
  "black.workspace.title": "Zaovra Black | 選擇工作區",
  "black.workspace.selectPlan": "為此方案選擇一個工作區",
  "black.workspace.name": "工作區 {{n}}",
  "black.subscribe.title": "訂閱 Zaovra Black",
  ...
  "black.subscribe.success.title": "你已在 Zaovra Black 候補名單上",
  ...
  "workspace.newUser.feature.lockin.body":
    "將 Zen 與任何編碼代理結合使用，並在需要時隨時使用 Zaovra 連接其他供應商。",
  ...
  "workspace.newUser.step.login.after": "並選擇 Zaovra",
  "workspace.newUser.step.pasteKey": "貼上你的 API 金鑰",
  "workspace.newUser.step.models.before": "啟動 Zaovra 並執行",
  ...
  "workspace.keys.subtitle": "管理你的 API 金鑰以存取 Zaovra 服務。",
  "workspace.keys.create": "建立 API 金鑰",
  "workspace.keys.placeholder": "輸入金鑰名稱",
  "workspace.keys.empty": "建立 Zaovra 閘道器 API 金鑰",
  ...
  "workspace.black.subscription.message": "你已訂閱 Zaovra Black，費用為每月 ${{plan}}。",
  ...
  "workspace.black.waitlist.joined": "你已加入每月 ${{plan}} 的 Zaovra Black 方案候補名單。",
  "workspace.black.waitlist.ready": "我們已準備好將你加入每月 ${{plan}} 的 Zaovra Black 方案。",
  ...
  "workspace.lite.subscription.message": "您已訂閱 Zaovra Go。",
  ...
  "workspace.lite.subscription.selectProvider":
    "在您的 zaovra 設定中選擇「Zaovra Go」作為提供商，即可使用 Go 模型。",
  ...
  "workspace.lite.black.message": "您目前已訂閱 Zaovra Black 或在候補名單中。若要切換至 Go，請先取消訂閱。",
  "workspace.lite.other.message": "此工作區中的另一位成員已訂閱 Zaovra Go。每個工作區只能有一位成員訂閱。",
  "workspace.lite.promo.description":
    "Zaovra Go 起價為 {{price}}，之後 $10/月，並提供對熱門開放編碼模型的可靠存取，同時享有充裕的使用額度。",
  ...
  "download.title": "Zaovra | 下載",
  "download.meta.description": "下載適用於 macOS、Windows 與 Linux 的 Zaovra",
  "download.hero.title": "下載 Zaovra 桌面版",
  "download.hero.subtitle": "適用於 macOS、Windows 與 Linux 的 Beta 版現已提供",
  "download.hero.button": "下載 {{os}} 版",
  "download.section.terminal": "Zaovra 終端",
  "download.section.desktop": "Zaovra 桌面版",
  "download.section.extensions": "Zaovra 擴充功能",
  "download.section.integrations": "Zaovra 整合",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但很可能需要。如果你想將 Zaovra 連接到付費供應商，你需要 AI 訂閱，不過你也可以使用",
  "download.faq.a3.localLink": "本地模型",
  "download.faq.a3.afterLocal.beforeZen": "免費。我們也推薦使用",
  "download.faq.a3.afterZen": "，但 Zaovra 同樣支援 OpenAI、Anthropic、xAI 等所有主流供應商。",

  "download.faq.a5.p1": "Zaovra 100% 免費使用。",
  "download.faq.a5.p2.beforeZen": "額外費用來自你對模型供應商的訂閱。雖然 Zaovra 支援任何模型供應商，但我們建議使用",
  "download.faq.a5.p2.afterZen": "。",

  "download.faq.a6.p1": "你的資料與資訊只會在你於 Zaovra 中建立可分享連結時被儲存。",
  "download.faq.a6.p2.beforeShare": "了解更多關於",
  "download.faq.a6.shareLink": "分享頁面",

  "enterprise.title": "Zaovra | 面向組織的企業解決方案",
  "enterprise.meta.description": "聯絡 Zaovra 取得企業解決方案",
  "enterprise.hero.title": "你的程式碼屬於你",
  "enterprise.hero.body1":
    "Zaovra 在你的組織內部安全運作，不會儲存任何資料或上下文，也沒有授權限制或所有權主張。你可以先與團隊進行試用，然後透過與你的 SSO 與內部 AI 閘道器整合，將其部署到整個組織。",
  ...
  "enterprise.faq.q1": "什麼是 Zaovra Enterprise？",
  "enterprise.faq.a1":
    "Zaovra Enterprise 適用於希望確保程式碼與資料絕不離開自己基礎設施的組織。透過中央化設定，它可與你的 SSO 與內部 AI 閘道器整合，以達成此目標。",
  "enterprise.faq.q2": "如何開始使用 Zaovra Enterprise？",
  "enterprise.faq.a2":
    "只要先以團隊的內部試用開始。Zaovra 預設不會儲存你的程式碼或上下文資料，所以上手非常容易。之後聯絡我們，討論定價與完整實作方案。",
  "enterprise.faq.q3": "企業定價是如何進行的？",
  "enterprise.faq.a3":
    "我們提供按席位的企業定價。如果你有自己的 LLM 閘道器，我們不會對使用的 token 另外收費。更多詳情，請聯絡我們以獲得依據組織需求的客製報價。",
  "enterprise.faq.q4": "我的資料在 Zaovra Enterprise 中是安全的嗎？",
  "enterprise.faq.a4":
    "是的。Zaovra 不會儲存你的程式碼或上下文資料。所有處理都會在本地或透過直接呼叫你的 AI 供應商 API 完成。透過中央化設定與 SSO 整合，你的資料會安全保留在組織的基礎設施內部。",

  "brand.title": "Zaovra | 品牌",
  "brand.meta.description": "Zaovra 品牌指南",
  "brand.heading": "品牌指南",
  "brand.subtitle": "協助你使用 Zaovra 品牌的資源與素材。",
  "brand.downloadAll": "下載所有素材",

  "changelog.title": "Zaovra | 更新日誌",
  "changelog.meta.description": "Zaovra 發布說明與更新日誌",
  "changelog.hero.title": "更新日誌",
  "changelog.hero.subtitle": "Zaovra 的新更新與改善",
  ...
  "home.next.metaTitle": "Zaovra — 扎根真實工作區的 AI 程式開發",
  "home.next.metaDescription": "本地優先的桌面 AI 程式開發工作台，支援 BYOK、檔案審查、內建終端與開發中的 WorkGraph 預覽。",
  "home.next.nav.ariaLabel": "首頁導覽",
  "home.next.nav.product": "產品",
  "home.next.nav.byok": "BYOK",
  "home.next.nav.workgraph": "WorkGraph 預覽",
  "home.next.action.download": "下載",
  "home.next.action.downloadBeta": "下載桌面 Beta 版",
  "home.next.action.github": "在 GitHub 查看",
  "home.next.action.providerDocs": "查看模型接入文件",
  "home.next.action.source": "查看原始碼",
  "home.next.hero.eyebrow": "桌面應用程式 · Beta",
  "home.next.hero.title": "扎根真實工作區的 AI 程式開發。",
  "home.next.hero.body": "在同一個桌面工作台中理解程式碼、規劃修改、執行命令並審查結果；既可使用自己的模型憑證，也可使用有效的 Zaovra 訂閱。",
  "home.next.hero.platforms": "支援 macOS、Windows 和 Linux",
  "home.next.proof.ariaLabel": "Zaovra 產品原則",
  "home.next.proof.byok.title": "自帶模型金鑰",
  "home.next.proof.byok.body": "連接並使用由你自行管理的模型提供商憑證。",
  "home.next.proof.workspace.title": "真實工作區",
  "home.next.proof.workspace.body": "圍繞專案檔案、工作階段、工具和終端開展工作。",
  "home.next.proof.review.title": "修改可審查",
  "home.next.proof.review.body": "繼續之前先查看檔案修改和命令輸出。",
  "home.next.workflow.kicker": "一個連接完整的工作區",
  "home.next.workflow.title": "工作所需的一切，都觸手可及。",
  "home.next.workflow.body": "工作區上下文、模型選擇、工作階段、工具和審查始終圍繞目前任務清晰可見。",
  "home.next.workflow.explore.title": "理解",
  "home.next.workflow.explore.body": "載入工作區上下文，找到與任務相關的程式碼。",
  "home.next.workflow.plan.title": "規劃",
  "home.next.workflow.plan.body": "把需求轉成具體的修改和驗證步驟。",
  "home.next.workflow.execute.title": "執行",
  "home.next.workflow.execute.body": "在權限控制下編輯檔案並執行命令。",
  "home.next.workflow.review.title": "審查",
  "home.next.workflow.review.body": "檢查差異、終端輸出和最終結果。",
  "home.next.workbench.kicker": "桌面工作台",
  "home.next.workbench.title": "讓工作過程保持可見。",
  "home.next.workbench.body": "工作階段、檔案修改、終端輸出、編輯器服務和權限請求集中在一個專注的桌面介面中。",
  "home.next.workbench.sessions.title": "工作階段與工作區",
  "home.next.workbench.sessions.body": "有序管理多個工作階段和專案，同時保留各自的工作上下文。",
  "home.next.workbench.review.title": "檔案審查",
  "home.next.workbench.review.body": "直接閱讀程式碼差異，在修改檔案之間切換，並讓審查緊鄰對話。",
  "home.next.workbench.tools.title": "終端、LSP 與權限",
  "home.next.workbench.tools.body": "查看命令輸出和語言服務狀態，並對敏感操作保留明確控制。",
  "home.next.byok.kicker": "模型選擇權在你",
  "home.next.byok.title": "連接你已經在使用的模型服務。",
  "home.next.byok.body": "BYOK 是 Zaovra 的正式使用路徑。連接自己的憑證，讓模型存取與計費繼續歸屬於你控制的提供商帳戶。",
  "home.next.byok.account": "本地 Agent 使用 BYOK 時不要求 Zaovra 帳戶。",
  "home.next.byok.providers": "可從桌面應用程式連接受支援的模型提供商憑證。",
  "home.next.byok.endpoint": "可設定自訂或本地 OpenAI-compatible 端點。",
  "home.next.workgraph.badge": "預覽 · 開發中",
  "home.next.workgraph.kicker": "正在建構",
  "home.next.workgraph.title": "讓任務不只存在於一次對話裡。",
  "home.next.workgraph.body": "WorkGraph 是一個正在開發的真實預覽，用於把目標組織成任務、嘗試、修復和證據；正式發布前，其可用範圍和行為仍可能變化。",
  "home.next.workgraph.goal": "把目標組織成明確的任務和依賴關係。",
  "home.next.workgraph.control": "在清晰邊界暫停、恢復、修復或重新規劃。",
  "home.next.workgraph.evidence": "讓執行嘗試和證據始終對應到所支援的工作。",
  "home.next.open.kicker": "本地優先，程式碼開放",
  "home.next.open.title": "在你了解的基礎設施上使用 Zaovra。",
  "home.next.open.workspace.title": "扎根你的工作區",
  "home.next.open.workspace.body": "桌面應用程式圍繞你選擇的工作區運行，也可以連接本地或自行運行的 Zaovra server。",
  "home.next.open.source.title": "MIT 授權條款",
  "home.next.open.source.body": "閱讀實作、按需調整，並透過公開儲存庫參與貢獻。",
  "home.next.access.kicker": "兩種模型接入路徑",
  "home.next.access.title": "選擇模型如何接入。",
  "home.next.access.body": "桌面工作流程保持一致，模型存取和計費邊界由你選擇。",
  "home.next.access.byok.label": "更適合自主控制",
  "home.next.access.byok.title": "自帶模型金鑰",
  "home.next.access.byok.body": "使用受支援的提供商憑證，或連接 OpenAI-compatible 端點。",
  "home.next.access.byok.point1": "本地 BYOK 使用不要求 Zaovra 帳戶",
  "home.next.access.byok.point2": "不消耗 Zaovra 託管推理",
  "home.next.access.subscription.label": "託管接入",
  "home.next.access.subscription.title": "Zaovra 訂閱",
  "home.next.access.subscription.body": "登入並擁有有效訂閱後，使用 Zaovra 託管模型接入。",
  "home.next.access.subscription.point1": "必須擁有有效訂閱",
  "home.next.access.subscription.point2": "此處不暗示任何方案名稱、價格或額度",
  "home.next.faq.kicker": "真實產品邊界",
  "home.next.faq.title": "直接回答。",
  "home.next.faq.account.q": "使用 BYOK 需要 Zaovra 帳戶嗎？",
  "home.next.faq.account.a": "不需要。你可以不登入 Zaovra 帳戶，直接用自己的模型提供商憑證運行本地 Agent；這些請求也不會消耗 Zaovra 託管推理。",
  "home.next.faq.local.q": "可以連接本地模型服務嗎？",
  "home.next.faq.local.a": "可以設定自訂或本地 OpenAI-compatible 端點；具體模型行為取決於該端點和模型本身。",
  "home.next.faq.workgraph.q": "現在可以使用 WorkGraph 嗎？",
  "home.next.faq.workgraph.a": "WorkGraph 目前是開發中的預覽。其介面、行為和正式發布範圍仍可能變化。",
  "home.next.faq.desktop.q": "桌面應用程式包含哪些能力？",
  "home.next.faq.desktop.a": "Beta 版把工作階段、工作區上下文、檔案審查、內建終端、LSP 狀態和權限控制集中在一個介面中。",
  "home.next.faq.open.q": "Zaovra 是開源的嗎？",
  "home.next.faq.open.a": "是。程式碼儲存庫公開，並使用 MIT 授權條款。",
  "home.next.download.kicker": "從你的工作區開始",
  "home.next.download.title": "把 Zaovra 帶到你正在開發的程式碼中。",
  "home.next.download.body": "下載桌面 Beta 版，或使用你熟悉的方式安裝命令列工具。",
  "home.next.install.ariaLabel": "安裝 Zaovra",
} satisfies Dict
