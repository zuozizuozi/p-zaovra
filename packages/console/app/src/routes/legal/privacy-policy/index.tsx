...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      ...
      <Meta name="description" content="Zaovra privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At Zaovra, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of Zaovra is at all times subject to our Terms of Use,{" "}
                <a href={language.route("/legal/terms-of-service")}>https://zaovra.com/legal/terms-of-service</a>,
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the Zaovra website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about Zaovra.
                </li>
              ...
              <p>
                ...
                you, Zaovra or another party; enforcing any agreements with you; responding to claims that any posting
