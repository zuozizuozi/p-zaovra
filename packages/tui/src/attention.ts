...
import defaultSoundPath from "@zaovra-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@zaovra-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@zaovra-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@zaovra-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@zaovra-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@zaovra-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "zaovra"
const DEFAULT_PACK_ID = "zaovra.default"
