...
import { useBindings, useZaovraModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useZaovraModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.ZAOVRA_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
