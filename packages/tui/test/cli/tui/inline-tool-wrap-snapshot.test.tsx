...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "ZAOVRA.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/zaovra/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/zaovra (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/zaovra/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/zaovra/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const ZAOVRA_DB|ZAOVRA_DB|ZAOVRA_DEV|Global\\.Path\\.data|data =" in packages/zaovra/src (115 matches)',
  },
] as const
