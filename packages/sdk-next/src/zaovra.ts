import { Zaovra } from "@zaovra-ai/client/effect"
...
import { createEmbeddedRoutes } from "@zaovra-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Zaovra.create")(function* () {
  ...
  const client = yield* Zaovra.make({ baseUrl: "http://zaovra.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@zaovra-ai/sdk-next/Zaovra") {}
