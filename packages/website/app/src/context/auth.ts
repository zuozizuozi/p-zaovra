...
export const AuthClient = createClient({
  clientID: "app",
  // Vercel serves the issuer in this app; SST can supply its separate auth URL.
  issuer: import.meta.env.VITE_AUTH_URL || process.env.OPENAUTH_ISSUER || `${config.baseUrl}/issuer`,
})
