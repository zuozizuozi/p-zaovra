...
export const dict = {
  ...
  "home.next.metaTitle": "Zaovra — 第三代桌面 Coding Agent",
  "home.next.metaDescription": "需要账号登录的桌面 Coding Agent，支持 BYOK、会员托管模型、文件审查、内置终端与长任务。",
  ...
  "home.next.hero.title": "扎根真实工作区的第三代 Coding Agent。",
  "home.next.hero.body": "登录后，在同一个桌面工作台中理解代码、规划修改、运行命令并审查结果；既可使用自己的模型凭据，也可使用 Zaovra 会员托管模型。",
  "home.next.hero.platforms": "Windows 首发 · macOS 即将推出",
  ...
  "home.next.byok.account": "必须登录 Zaovra 账号，但无需购买会员。",
  ...
  "home.next.open.kicker": "桌面优先，全程可审查",
  "home.next.open.title": "从需求到审查，让工作过程保持可见。",
  "home.next.open.workspace.title": "扎根你的工作区",
  "home.next.open.workspace.body": "桌面应用围绕你选择的真实工作区运行，并对敏感操作提供明确权限控制。",
  "home.next.open.source.title": "桌面优先的工作流",
  "home.next.open.source.body": "在真实项目中使用终端上下文、文件审查和清晰的执行边界。",
  ...
  "home.next.access.byok.point1": "必须登录 Zaovra 账号，但无需购买会员",
  ...
  "home.next.access.subscription.point2": "在价格页选择 Starter、Pro 或 Max",
  "home.next.faq.kicker": "真实产品边界",
  "home.next.faq.title": "直接回答。",
  "home.next.faq.account.q": "使用 BYOK 需要 Zaovra 账户吗？",
  "home.next.faq.account.a": "需要。桌面端始终要求登录 Zaovra 账号，但 BYOK 无需购买会员，也不会消耗 Zaovra 托管模型额度。",
  ...
  "home.next.faq.open.a": "不是。Zaovra 是商业桌面产品，不以开源项目形式对外宣传。",
  "home.next.download.kicker": "从你的工作区开始",
  "home.next.download.title": "把 Zaovra 带到你正在开发的代码中。",
  "home.next.download.body": "下载 Windows 版 Zaovra；macOS 版本即将推出。",
