...
export const TypeId: TypeId = "~@zaovra-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@zaovra-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@zaovra-ai/effect-sqlite-node/NodeSqliteClient")
