export const dict = {
  ...
  "dialog.provider.zaovra.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.zaovra.tagline": "Modèles optimisés et fiables",
  "dialog.provider.zaovraGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Zaovra",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Zaovra.",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.zaovraZen.visit.prefix": "Visitez ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Zaovra.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Zaovra.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans zaovra.json",
  ...
  "dialog.server.description": "Changez le serveur Zaovra auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingZaovra": "Vérification d'Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "Vérification d'Zaovra dans {{distro}}...",
  "wsl.onboarding.updatingZaovra": "Mise à jour d'Zaovra...",
  "wsl.onboarding.updatingZaovraIn": "Mise à jour d'Zaovra dans {{distro}}...",
  "wsl.onboarding.updateZaovraIn": "Mettez à jour Zaovra dans {{distro}}.",
  "wsl.onboarding.updateZaovra": "Mettre à jour Zaovra",
  "wsl.onboarding.zaovraReadyIn": "Zaovra est prêt dans {{distro}}.",
  "wsl.onboarding.zaovraReady": "Zaovra est prêt.",
  "wsl.onboarding.installZaovraIn": "Installez Zaovra dans {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Zaovra puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Zaovra n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Zaovra.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Zaovra ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Zaovra",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (zaovra.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Zaovra ne supporte pas encore l'authentification MCP.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Zaovra dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Zaovra",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Zaovra sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Zaovra suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Zaovra.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Zaovra",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Zaovra.",
