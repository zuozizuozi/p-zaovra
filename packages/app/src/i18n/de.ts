...
export const dict = {
  ...
  "dialog.provider.zaovra.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.zaovra.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.zaovraGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Zaovra",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Zaovra zu nutzen.",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.zaovraZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Zaovra zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Zaovra zu nutzen.",
  ...
  "dialog.plugins.empty": "In zaovra.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Zaovra-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingZaovra": "Zaovra wird geprüft...",
  "wsl.onboarding.checkingZaovraIn": "Zaovra in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingZaovra": "Zaovra wird aktualisiert...",
  "wsl.onboarding.updatingZaovraIn": "Zaovra in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateZaovraIn": "Aktualisieren Sie Zaovra in {{distro}}.",
  "wsl.onboarding.updateZaovra": "Zaovra aktualisieren",
  "wsl.onboarding.zaovraReadyIn": "Zaovra ist in {{distro}} bereit.",
  "wsl.onboarding.zaovraReady": "Zaovra ist bereit.",
  "wsl.onboarding.installZaovraIn": "Installieren Sie Zaovra in {{distro}}.",
  "wsl.onboarding.installZaovra": "Zaovra installieren",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Zaovra einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Zaovra konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Zaovra erneut.",
  ...
  "toast.update.description": "Eine neue Version von Zaovra ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Zaovra-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (zaovra.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Zaovra unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Zaovra enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Zaovra-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Zaovra ändern",
  ...
  "settings.updates.row.startup.description": "Beim Start von Zaovra automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Zaovra.",
