export const dict = {
  ...
  "dialog.provider.zaovra.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.zaovra.tagline": "Reliable optimized models",
  "dialog.provider.zaovraGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.zaovraZen.visit.suffix": " to collect your API key.",
