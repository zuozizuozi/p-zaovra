...
export const dict = {
  ...
  "dialog.provider.zaovra.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.zaovra.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.zaovraGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Zaovra",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Zaovra.",
  ...
  "provider.connect.zaovraZen.line1":
    "Zaovra Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.zaovraZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.zaovraZen.visit.prefix": "Besøk ",
  "provider.connect.zaovraZen.visit.link": "zaovra.com/zen",
  "provider.connect.zaovraZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Zaovra.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Zaovra.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i zaovra.json",
  ...
  "dialog.server.description": "Bytt hvilken Zaovra-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Zaovra ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Zaovra-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (zaovra.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Zaovra ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Zaovra inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Zaovra-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Zaovra",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Zaovra ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Zaovra skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Zaovra er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Zaovra starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Zaovra.",
  ...
  "wsl.onboarding.checkingZaovra": "Sjekker Zaovra...",
  "wsl.onboarding.checkingZaovraIn": "Sjekker Zaovra i {{distro}}...",
  "wsl.onboarding.updatingZaovra": "Oppdaterer Zaovra...",
  "wsl.onboarding.updatingZaovraIn": "Oppdaterer Zaovra i {{distro}}...",
  "wsl.onboarding.updateZaovraIn": "Oppdater Zaovra i {{distro}}.",
  "wsl.onboarding.updateZaovra": "Oppdater Zaovra",
  ...
  "wsl.onboarding.distroStatus.zaovraMissing": "Zaovra er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Zaovra kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Zaovra kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Zaovra på nytt.",
