...
export function useTitlebarRightMount() {
  ...
  onMount(() => setMount(document.getElementById("zaovra-titlebar-right")))
  return mount
}
        ...
        <Match when>
          ...
          >
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="zaovra-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="zaovra-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_ZAOVRA_CHANNEL) && (
