...
import { showToast } from "@zaovra-ai/ui/toast"
...
import { LoaderV2 } from "@zaovra-ai/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@zaovra-ai/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-zaovra") {
      await run(() => api.installZaovra(distro))
      return
    }
