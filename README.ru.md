...
# Менеджеры пакетов
npm i -g zaovra-ai@latest        # или bun/pnpm/yarn
scoop install zaovra             # Windows
choco install zaovra             # Windows
brew install zuozizuozi/tap/zaovra # macOS и Linux (рекомендуем, всегда актуально)
brew install zaovra              # macOS и Linux (официальная формула brew, обновляется реже)
sudo pacman -S zaovra            # Arch Linux (Stable)
paru -S zaovra-bin               # Arch Linux (Latest from AUR)
mise use -g zaovra               # любая ОС
nix run nixpkgs#zaovra           # или github:zuozizuozi/p-zaovra для самой свежей ветки dev
```
...
Zaovra также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/zuozizuozi/p-zaovra/releases) или с [zaovra.com/download](https://zaovra.com/download).
...
1. `$ZAOVRA_INSTALL_DIR` - Пользовательский каталог установки
2. `$XDG_BIN_DIR` - Путь, совместимый со спецификацией XDG Base Directory
3. `$HOME/bin` - Стандартный каталог пользовательских бинарников (если существует или можно создать)
4. `$HOME/.zaovra/bin` - Fallback по умолчанию
...
В Zaovra есть два встроенных агента, между которыми можно переключаться клавишей `Tab`.
...
Подробнее об [agents](https://zaovra.com/docs/agents).

### Документация

Больше информации о том, как настроить Zaovra: [**наши docs**](https://zaovra.com/docs).

### Вклад

Если вы хотите внести вклад в Zaovra, прочитайте [contributing docs](./CONTRIBUTING.md) перед тем, как отправлять pull request.

### Разработка на базе Zaovra

Если вы делаете проект, связанный с Zaovra, и используете "zaovra" как часть имени (например, "zaovra-dashboard" или "zaovra-mobile"), добавьте примечание в README, чтобы уточнить, что проект не создан командой Zaovra и не аффилирован с нами.

---

**Присоединяйтесь к нашему сообществу** [Discord](https://discord.gg/zaovra) | [X.com](https://x.com/zaovra)
