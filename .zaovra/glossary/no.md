...
- PR #10018: https://github.com/zuozizuozi/p-zaovra/pull/10018
- PR #12935: https://github.com/zuozizuozi/p-zaovra/pull/12935

## Do Not Translate (Locale Additions)

- `Zaovra` (preserve casing in prose; keep `zaovra` only in commands, package names, paths, or code)
- `Zaovra CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
