...
Use this folder for locale-specific translation guidance that supplements `.zaovra/agent/translator.md`.
...
- PR #12345: https://github.com/zuozizuozi/p-zaovra/pull/12345

## Do Not Translate (Locale Additions)

- `Zaovra` (preserve casing)
