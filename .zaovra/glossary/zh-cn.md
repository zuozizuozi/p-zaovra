...
- PR #13942: https://github.com/zuozizuozi/p-zaovra/pull/13942

## Do Not Translate (Locale Additions)

- `Zaovra` (preserve casing in prose; keep `zaovra` only when it is part of commands, package names, paths, or code)
- `Zaovra Zen`
- `Zaovra CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `zaovra` in prose when referring to the product name; use `Zaovra`
