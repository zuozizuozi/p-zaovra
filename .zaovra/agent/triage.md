...
Desktop application and browser-based app issues, including `zaovra web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core zaovra server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Zaovra Zen, Zaovra Go, and billing issues.
